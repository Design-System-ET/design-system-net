...
namespace DesignSystem.Programs {
   public class gamapppermissionchildren : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV51ManageFiltersExecutionStep, AV46ColumnsSelector, AV69Pgmname, AV15FilName, AV22PermissionId, AV8ApplicationId, AV62IsAuthorized_Name, AV63IsAuthorized_Insert) ;
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       DesignSystem.Programs.wwpbaseobjects.SdtWWPColumnsSelector AV46ColumnsSelector ,
                                       string AV69Pgmname ,
                                       string AV15FilName ,
      ...
      {
         /* GeneXus formulas. */
         AV69Pgmname = "GAMAppPermissionChildren";
      ...
      protected void E181P2( )
      {
         ...
         /* Refresh Routine */
         returnInSub = false;
         new DesignSystem.Programs.wwpbaseobjects.loadwwpcontext(context ).execute( out  AV29WWPContext) ;
         ...
         edtavName_Visible = (((DesignSystem.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV46ColumnsSelector.gxTpr_Columns.Item(1)).gxTpr_Isvisible ? 1 : 0);
         AssignProp("", false, edtavName_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavName_Visible), 5, 0), !bGXsfl_42_Refreshing);
         edtavDsc_Visible = (((DesignSystem.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV46ColumnsSelector.gxTpr_Columns.Item(2)).gxTpr_Isvisible ? 1 : 0);
         AssignProp("", false, edtavDsc_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavDsc_Visible), 5, 0), !bGXsfl_42_Refreshing);
         cmbavAccesstype.Visible = (((DesignSystem.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV46ColumnsSelector.gxTpr_Columns.Item(3)).gxTpr_Isvisible ? 1 : 0);
         ...
         new DesignSystem.Programs.wwpbaseobjects.wwp_getappliedfiltersdescription(context ).execute(  AV69Pgmname, out  GXt_char3) ;
      ...
      private void E191P2( )
      {
         ...
         AV70GXV1 = 1;
         while ( AV70GXV1 <= AV24AppPermissions.Count )
         {
            AV9AppPermission = ((GeneXus.Programs.genexussecurity.SdtGAMApplicationPermission)AV24AppPermissions.Item(AV70GXV1));
      ...
      protected void E141P2( )
      {
         ...
         new DesignSystem.Programs.wwpbaseobjects.savecolumnsselectorstate(context ).execute(  "GAMAppPermissionChildrenColumnsSelector",  (String.IsNullOrEmpty(StringUtil.RTrim( AV34ColumnsSelectorXML)) ? "" : AV46ColumnsSelector.ToXml(false, true, "", ""))) ;
      ...
      protected void E111P2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("GAMAppPermissionChildrenFilters")) + "," + UrlEncode(StringUtil.RTrim(AV69Pgmname+"GridState"));
         ...
         else
         {
            ...
            new DesignSystem.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "GAMAppPermissionChildrenFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
            ...
            else
            {
               ...
               S162 ();
               if (returnInSub) return;
               new DesignSystem.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV69Pgmname+"GridState",  AV52ManageFiltersXml) ;
      ...
      protected void S152( )
      {
         ...
         returnInSub = false;
         AV46ColumnsSelector = new DesignSystem.Programs.wwpbaseobjects.SdtWWPColumnsSelector(context);
         new DesignSystem.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV46ColumnsSelector,  "&Name",  "",  "WWP_GAM_PermissionName",  true,  "") ;
         new DesignSystem.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV46ColumnsSelector,  "&Dsc",  "",  "WWP_GAM_Description",  true,  "") ;
         new DesignSystem.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV46ColumnsSelector,  "&AccessType",  "",  "WWP_GAM_DefaultAccess",  true,  "") ;
         GXt_char3 = AV41UserCustomValue;
         new DesignSystem.Programs.wwpbaseobjects.loadcolumnsselectorstate(context ).execute(  "GAMAppPermissionChildrenColumnsSelector", out  GXt_char3) ;
         ...
         if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV41UserCustomValue)) ) )
         {
            ...
            new DesignSystem.Programs.wwpbaseobjects.wwp_columnselector_updatecolumns(context ).execute( ref  AV60ColumnsSelectorAux, ref  AV46ColumnsSelector) ;
         }
      }
      ...
      protected void S132( )
      {
         ...
         new DesignSystem.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "gamapppermissionselect_Execute", out  GXt_boolean1) ;
      ...
      protected void S112( )
      {
         ...
         new DesignSystem.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "GAMAppPermissionChildrenFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         {
            AV32GridState.FromXml(new DesignSystem.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV69Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV32GridState.FromXml(AV50Session.Get(AV69Pgmname+"GridState"), null, "", "");
         }
         /* Execute user subroutine: 'LOADREGFILTERSSTATE' */
         S172 ();
         if (returnInSub) return;
      ...
      protected void S172( )
      {
         ...
         {
            AV33GridStateFilterValue = ((DesignSystem.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV32GridState.gxTpr_Filtervalues.Item(AV71GXV2));
      ...
      protected void S142( )
      {
         ...
         new DesignSystem.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV32GridState,  "FILNAME",  context.GetMessage( "WWP_GAM_Name", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV15FilName)),  0,  AV15FilName,  AV15FilName,  false,  "",  "") ;
         ...
         new DesignSystem.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV69Pgmname+"GridState",  AV32GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void E201P2( )
      {
         ...
         {
            AV72GXV3 = 1;
            while ( AV72GXV3 <= AV14Errors.Count )
            {
               AV13Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV14Errors.Item(AV72GXV3));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024121623572791", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamapppermissionchildren.js", "?2024121623572795", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"AV51ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV46ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV69Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV15FilName","fld":"vFILNAME"},{"av":"AV22PermissionId","fld":"vPERMISSIONID","hsh":true},{"av":"AV8ApplicationId","fld":"vAPPLICATIONID","pic":"ZZZZZZZZZZZ9","hsh":true},{"av":"AV62IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true},{"av":"AV63IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true}]""");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E121P2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV51ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV46ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV69Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV15FilName","fld":"vFILNAME"},{"av":"AV22PermissionId","fld":"vPERMISSIONID","hsh":true},{"av":"AV8ApplicationId","fld":"vAPPLICATIONID","pic":"ZZZZZZZZZZZ9","hsh":true},{"av":"AV62IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true},{"av":"AV63IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E191P2","iparms":[{"av":"AV15FilName","fld":"vFILNAME"},{"av":"AV22PermissionId","fld":"vPERMISSIONID","hsh":true},{"av":"AV8ApplicationId","fld":"vAPPLICATIONID","pic":"ZZZZZZZZZZZ9","hsh":true},{"av":"AV62IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true}]""");
         ...
         setEventMetadata("'DOCLOSE'","""{"handler":"E151P2","iparms":[{"av":"AV8ApplicationId","fld":"vAPPLICATIONID","pic":"ZZZZZZZZZZZ9","hsh":true}]}""");
      ...
      public override void initialize( )
      {
         ...
         AV29WWPContext = new DesignSystem.Programs.wwpbaseobjects.SdtWWPContext(context);
         ...
         AV24AppPermissions = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMApplicationPermission>( context, "GeneXus.Programs.genexussecurity.SdtGAMApplicationPermission", "DesignSystem.Programs");
         ...
         pr_gam = new DataStoreProvider(context, new DesignSystem.Programs.gamapppermissionchildren__gam(),
            new Object[][] {
            }
         );
         pr_default = new DataStoreProvider(context, new DesignSystem.Programs.gamapppermissionchildren__default(),
            new Object[][] {
            }
         );
         AV69Pgmname = "GAMAppPermissionChildren";
      ...
      private DesignSystem.Programs.wwpbaseobjects.SdtWWPColumnsSelector AV46ColumnsSelector ;
      ...
      private DesignSystem.Programs.wwpbaseobjects.SdtWWPContext AV29WWPContext ;
