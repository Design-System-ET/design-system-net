...
namespace DesignSystem.Programs {
   public class gamrecoverpasswordstep2 : GXDataArea
   {
      ...
      protected void E120B2( )
      {
         ...
         {
            AV13User = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getuserbylogin(AV14UserAuthTypeName, AV15UserName, out  AV27Errors);
            if ( AV27Errors.Count == 0 )
            {
               AV6ChangePwdOK = AV13User.changepasswordbykey(AV10KeyToChangePassword, AV16UserPasswordNew, out  AV27Errors);
               if ( AV6ChangePwdOK )
               {
                  ...
                  AV11LoginOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).login(AV15UserName, AV16UserPasswordNew, AV5AdditionalParameter, out  AV27Errors);
                  if ( AV11LoginOK )
                  {
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV30GXV1 = 1;
         while ( AV30GXV1 <= AV27Errors.Count )
         {
            AV26Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV27Errors.Item(AV30GXV1));
            GX_msglist.addItem(StringUtil.Format( "%1", AV26Error.gxTpr_Message, "", "", "", "", "", "", "", ""));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024121623465931", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamrecoverpasswordstep2.js", "?2024121623465937", false, true);
      ...
      public override void initialize( )
      {
         ...
         AV27Errors = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError>( context, "GeneXus.Programs.genexussecurity.SdtGAMError", "DesignSystem.Programs");
         ...
         pr_gam = new DataStoreProvider(context, new DesignSystem.Programs.gamrecoverpasswordstep2__gam(),
            new Object[][] {
            }
         );
         pr_default = new DataStoreProvider(context, new DesignSystem.Programs.gamrecoverpasswordstep2__default(),
            new Object[][] {
            }
         );
         /* GeneXus formulas. */
