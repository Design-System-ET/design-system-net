...
namespace DesignSystem.Programs {
   public class gamappmenuentry : GXDataArea
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20241217041250", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamappmenuentry.js", "?20241217041251", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","""{"handler":"E12282","iparms":[{"av":"AV7ApplicationId","fld":"vAPPLICATIONID","pic":"ZZZZZZZZZZZ9","hsh":true},{"av":"AV14Name","fld":"vNAME"},{"av":"Gx_mode","fld":"vMODE","pic":"@!","hsh":true},{"av":"AV12GUID","fld":"vGUID"},{"av":"AV9Dsc","fld":"vDSC"},{"av":"AV13Id","fld":"vID","pic":"ZZZZZZZZZZZ9","hsh":true},{"av":"AV6isOK","fld":"vISOK"}]""");
      ...
      public override void initialize( )
      {
         ...
         pr_gam = new DataStoreProvider(context, new DesignSystem.Programs.gamappmenuentry__gam(),
            new Object[][] {
            }
         );
         pr_default = new DataStoreProvider(context, new DesignSystem.Programs.gamappmenuentry__default(),
            new Object[][] {
            }
         );
         /* GeneXus formulas. */
