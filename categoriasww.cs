...
namespace DesignSystem.Programs {
   public class categoriasww : GXDataArea
   {
      public categoriasww( )
      {
      ...
      public categoriasww( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV29TFCategoriasCategoria = GetPar( "TFCategoriasCategoria");
         AV30TFCategoriasCategoria_Sel = GetPar( "TFCategoriasCategoria_Sel");
         ...
         gxgrGrid_refresh( subGrid_Rows, AV14OrderedDsc, AV16FilterFullText, AV26ManageFiltersExecutionStep, AV21ColumnsSelector, AV45Pgmname, AV29TFCategoriasCategoria, AV30TFCategoriasCategoria_Sel, AV39IsAuthorized_Display, AV40IsAuthorized_Update, AV41IsAuthorized_Delete, AV44IsAuthorized_Insert) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("categoriasww.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV45Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV45Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "vTFCATEGORIASCATEGORIA", StringUtil.RTrim( AV29TFCategoriasCategoria));
         GxWebStd.gx_hidden_field( context, "vTFCATEGORIASCATEGORIA_SEL", StringUtil.RTrim( AV30TFCategoriasCategoria_Sel));
      ...
      {
         return formatLink("categoriasww.aspx")  ;
      }
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       string AV45Pgmname ,
                                       string AV29TFCategoriasCategoria ,
                                       string AV30TFCategoriasCategoria_Sel ,
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_CATEGORIASID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A20CategoriasId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "CATEGORIASID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A20CategoriasId), 4, 0, ".", "")));
      }
      ...
      protected void RF2U2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H002U2 */
            pr_default.execute(0, new Object[] {lV46Categoriaswwds_1_filterfulltext, lV47Categoriaswwds_2_tfcategoriascategoria, AV48Categoriaswwds_3_tfcategoriascategoria_sel, GXPagingFrom2, GXPagingTo2});
            nGXsfl_44_idx = 1;
            sGXsfl_44_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_44_idx), 4, 0), 4, "0");
            SubsflControlProps_442( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A21CategoriasCategoria = H002U2_A21CategoriasCategoria[0];
               A20CategoriasId = H002U2_A20CategoriasId[0];
               /* Execute user event: Grid.Load */
               E202U2 ();
      ...
      protected void send_integrity_lvl_hashes2U2( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_DELETE", AV41IsAuthorized_Delete);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_DELETE", GetSecureSignedToken( "", AV41IsAuthorized_Delete, context));
         GxWebStd.gx_hidden_field( context, "gxhash_CATEGORIASID"+"_"+sGXsfl_44_idx, GetSecureSignedToken( sGXsfl_44_idx, context.localUtil.Format( (decimal)(A20CategoriasId), "ZZZ9"), context));
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_INSERT", AV44IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( "", AV44IsAuthorized_Insert, context));
      }
      ...
      {
         AV46Categoriaswwds_1_filterfulltext = AV16FilterFullText;
         AV47Categoriaswwds_2_tfcategoriascategoria = AV29TFCategoriasCategoria;
         AV48Categoriaswwds_3_tfcategoriascategoria_sel = AV30TFCategoriasCategoria_Sel;
         ...
         lV47Categoriaswwds_2_tfcategoriascategoria = StringUtil.PadR( StringUtil.RTrim( AV47Categoriaswwds_2_tfcategoriascategoria), 100, "%");
         /* Using cursor H002U3 */
         pr_default.execute(1, new Object[] {lV46Categoriaswwds_1_filterfulltext, lV47Categoriaswwds_2_tfcategoriascategoria, AV48Categoriaswwds_3_tfcategoriascategoria_sel});
      ...
      protected void E182U2( )
      {
         ...
         AV42AGExportData = new GXBaseCollection<DesignSystem.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item>( context, "Item", "");
         AV43AGExportDataItem = new DesignSystem.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item(context);
         AV43AGExportDataItem.gxTpr_Title = context.GetMessage( "WWP_ExportCaption", "");
         ...
         AV43AGExportDataItem = new DesignSystem.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item(context);
         AV43AGExportDataItem.gxTpr_Title = context.GetMessage( "WWP_ExportReportCaption", "");
      ...
      protected void E192U2( )
      {
         ...
         if ( StringUtil.StrCmp(AV23Session.Get("CategoriasWWColumnsSelector"), "") != 0 )
         {
            AV19ColumnsSelectorXML = AV23Session.Get("CategoriasWWColumnsSelector");
         ...
         edtCategoriasCategoria_Visible = (((DesignSystem.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV21ColumnsSelector.gxTpr_Columns.Item(1)).gxTpr_Isvisible ? 1 : 0);
         AssignProp("", false, edtCategoriasCategoria_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtCategoriasCategoria_Visible), 5, 0), !bGXsfl_44_Refreshing);
         ...
         new DesignSystem.Programs.wwpbaseobjects.wwp_getappliedfiltersdescription(context ).execute(  AV45Pgmname, out  GXt_char2) ;
      ...
      protected void E152U2( )
      {
         ...
         {
            if ( StringUtil.StrCmp(Ddo_grid_Selectedcolumn, "CategoriasCategoria") == 0 )
            {
               AV29TFCategoriasCategoria = Ddo_grid_Filteredtext_get;
               AssignAttri("", false, "AV29TFCategoriasCategoria", AV29TFCategoriasCategoria);
               AV30TFCategoriasCategoria_Sel = Ddo_grid_Selectedvalue_get;
               AssignAttri("", false, "AV30TFCategoriasCategoria_Sel", AV30TFCategoriasCategoria_Sel);
            }
            subgrid_firstpage( ) ;
         }
         /*  Sending Event outputs  */
      ...
      protected void E162U2( )
      {
         ...
         new DesignSystem.Programs.wwpbaseobjects.savecolumnsselectorstate(context ).execute(  "CategoriasWWColumnsSelector",  (String.IsNullOrEmpty(StringUtil.RTrim( AV19ColumnsSelectorXML)) ? "" : AV21ColumnsSelector.ToXml(false, true, "", ""))) ;
      ...
      protected void E112U2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("CategoriasWWFilters")) + "," + UrlEncode(StringUtil.RTrim(AV45Pgmname+"GridState"));
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Manage#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("CategoriasWWFilters"));
         ...
         else
         {
            ...
            new DesignSystem.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "CategoriasWWFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char2) ;
            ...
            else
            {
               ...
               new DesignSystem.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV45Pgmname+"GridState",  AV25ManageFiltersXml) ;
      ...
      protected void E172U2( )
      {
         ...
         if ( AV44IsAuthorized_Insert )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "categorias.aspx"+UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode(StringUtil.LTrimStr(0,1,0));
            CallWebObject(formatLink("categorias.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
      ...
      protected void S162( )
      {
         ...
         new DesignSystem.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV21ColumnsSelector,  "CategoriasCategoria",  "",  "Categoria",  true,  "") ;
         GXt_char2 = AV20UserCustomValue;
         new DesignSystem.Programs.wwpbaseobjects.loadcolumnsselectorstate(context ).execute(  "CategoriasWWColumnsSelector", out  GXt_char2) ;
      ...
      protected void S142( )
      {
         ...
         new DesignSystem.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "categorias_Execute", out  GXt_boolean3) ;
         ...
         new DesignSystem.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "categorias_Update", out  GXt_boolean3) ;
         ...
         new DesignSystem.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "categorias_Delete", out  GXt_boolean3) ;
         ...
         new DesignSystem.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "categorias_Insert", out  GXt_boolean3) ;
      ...
      protected void S112( )
      {
         ...
         new DesignSystem.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "CategoriasWWFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S182( )
      {
         ...
         AV16FilterFullText = "";
         AssignAttri("", false, "AV16FilterFullText", AV16FilterFullText);
         AV29TFCategoriasCategoria = "";
         AssignAttri("", false, "AV29TFCategoriasCategoria", AV29TFCategoriasCategoria);
         AV30TFCategoriasCategoria_Sel = "";
         AssignAttri("", false, "AV30TFCategoriasCategoria_Sel", AV30TFCategoriasCategoria_Sel);
      ...
      protected void S202( )
      {
         ...
         if ( AV39IsAuthorized_Display )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "categorias.aspx"+UrlEncode(StringUtil.RTrim("DSP")) + "," + UrlEncode(StringUtil.LTrimStr(A20CategoriasId,4,0));
            CallWebObject(formatLink("categorias.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
            context.wjLocDisableFrm = 1;
         }
         else
      ...
      protected void S212( )
      {
         ...
         if ( AV40IsAuthorized_Update )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "categorias.aspx"+UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode(StringUtil.LTrimStr(A20CategoriasId,4,0));
            CallWebObject(formatLink("categorias.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
            context.wjLocDisableFrm = 1;
         }
         else
      ...
      protected void S222( )
      {
         ...
         if ( AV41IsAuthorized_Delete )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "categorias.aspx"+UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode(StringUtil.LTrimStr(A20CategoriasId,4,0));
            CallWebObject(formatLink("categorias.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
            context.wjLocDisableFrm = 1;
         }
         else
      ...
      protected void S132( )
      {
         ...
         {
            AV11GridState.FromXml(new DesignSystem.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV45Pgmname+"GridState"), null, "", "");
         }
         else
         {
      ...
      protected void S192( )
      {
         ...
         {
            AV12GridStateFilterValue = ((DesignSystem.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV11GridState.gxTpr_Filtervalues.Item(AV49GXV1));
            if ( StringUtil.StrCmp(AV12GridStateFilterValue.gxTpr_Name, "FILTERFULLTEXT") == 0 )
            {
               AV16FilterFullText = AV12GridStateFilterValue.gxTpr_Value;
               AssignAttri("", false, "AV16FilterFullText", AV16FilterFullText);
            }
            else if ( StringUtil.StrCmp(AV12GridStateFilterValue.gxTpr_Name, "TFCATEGORIASCATEGORIA") == 0 )
            {
               AV29TFCategoriasCategoria = AV12GridStateFilterValue.gxTpr_Value;
               AssignAttri("", false, "AV29TFCategoriasCategoria", AV29TFCategoriasCategoria);
            }
            else if ( StringUtil.StrCmp(AV12GridStateFilterValue.gxTpr_Name, "TFCATEGORIASCATEGORIA_SEL") == 0 )
            {
               AV30TFCategoriasCategoria_Sel = AV12GridStateFilterValue.gxTpr_Value;
               AssignAttri("", false, "AV30TFCategoriasCategoria_Sel", AV30TFCategoriasCategoria_Sel);
            }
            AV49GXV1 = (int)(AV49GXV1+1);
         }
         GXt_char2 = "";
         new DesignSystem.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV30TFCategoriasCategoria_Sel)),  AV30TFCategoriasCategoria_Sel, out  GXt_char2) ;
         Ddo_grid_Selectedvalue_set = GXt_char2;
         ucDdo_grid.SendProperty(context, "", false, Ddo_grid_Internalname, "SelectedValue_set", Ddo_grid_Selectedvalue_set);
         GXt_char2 = "";
         new DesignSystem.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV29TFCategoriasCategoria)),  AV29TFCategoriasCategoria, out  GXt_char2) ;
      ...
      protected void S152( )
      {
         ...
         new DesignSystem.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalueandsel(context ).execute( ref  AV11GridState,  "TFCATEGORIASCATEGORIA",  context.GetMessage( "Categoria", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV29TFCategoriasCategoria)),  0,  AV29TFCategoriasCategoria,  AV29TFCategoriasCategoria,  false,  "",  "",  !String.IsNullOrEmpty(StringUtil.RTrim( AV30TFCategoriasCategoria_Sel)),  AV30TFCategoriasCategoria_Sel,  AV30TFCategoriasCategoria_Sel) ;
         AV11GridState.gxTpr_Pagesize = StringUtil.Str( (decimal)(subGrid_Rows), 10, 0);
         AV11GridState.gxTpr_Currentpage = (short)(subGrid_fnc_Currentpage( ));
         new DesignSystem.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV45Pgmname+"GridState",  AV11GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void S232( )
      {
         ...
         new categoriaswwexport(context ).execute( out  AV17ExcelFilename, out  AV18ErrorMessage) ;
      ...
      protected void S242( )
      {
         ...
         Innewwindow1_Target = formatLink("categoriaswwexportreport.aspx") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20241217064787", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("categoriasww.js", "?20241217064789", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_442( )
      {
         ...
         edtCategoriasId_Internalname = "CATEGORIASID_"+sGXsfl_44_idx;
         edtCategoriasCategoria_Internalname = "CATEGORIASCATEGORIA_"+sGXsfl_44_idx;
      }

      protected void SubsflControlProps_fel_442( )
      {
         cmbavGridactions_Internalname = "vGRIDACTIONS_"+sGXsfl_44_fel_idx;
         edtCategoriasId_Internalname = "CATEGORIASID_"+sGXsfl_44_fel_idx;
         edtCategoriasCategoria_Internalname = "CATEGORIASCATEGORIA_"+sGXsfl_44_fel_idx;
      }
      ...
      protected void sendrow_442( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_44_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCategoriasId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A20CategoriasId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A20CategoriasId), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCategoriasId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)44,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+((edtCategoriasCategoria_Visible==0) ? "display:none;" : "")+"\">") ;
            }
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCategoriasCategoria_Internalname,StringUtil.RTrim( A21CategoriasCategoria),(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCategoriasCategoria_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(int)edtCategoriasCategoria_Visible,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)100,(short)0,(short)0,(short)44,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
      ...
      protected void StartGridControl44( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( "") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+((edtCategoriasCategoria_Visible==0) ? "display:none;" : "")+""+"\" "+">") ;
            context.SendWebValue( context.GetMessage( "Categoria", "")) ;
            context.WriteHtmlTextNl( "</th>") ;
         ...
         else
         {
            ...
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A20CategoriasId), 4, 0, ".", ""))));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( A21CategoriasCategoria)));
            GridColumn.AddObjectProperty("Visible", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtCategoriasCategoria_Visible), 5, 0, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
      ...
      public override void initialize_properties( )
      {
         ...
         edtCategoriasCategoria_Visible = -1;
         edtCategoriasCategoria_Enabled = 0;
         edtCategoriasId_Enabled = 0;
         subGrid_Sortable = 0;
         ...
         Ddo_grid_Datalistproc = "CategoriasWWGetFilterData";
         ...
         Ddo_grid_Columnids = "2:CategoriasCategoria";
         ...
         Dvpanel_unnamedtable1_Title = context.GetMessage( "Listado Categorias", "");
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"AV26ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV21ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV45Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV29TFCategoriasCategoria","fld":"vTFCATEGORIASCATEGORIA"},{"av":"AV30TFCategoriasCategoria_Sel","fld":"vTFCATEGORIASCATEGORIA_SEL"},{"av":"AV39IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV40IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV41IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV44IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"AV26ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV21ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtCategoriasCategoria_Visible","ctrl":"CATEGORIASCATEGORIA","prop":"Visible"},{"av":"AV35GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV36GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV37GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV39IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV40IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV41IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV44IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV24ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E122U2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV26ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV21ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV45Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV29TFCategoriasCategoria","fld":"vTFCATEGORIASCATEGORIA"},{"av":"AV30TFCategoriasCategoria_Sel","fld":"vTFCATEGORIASCATEGORIA_SEL"},{"av":"AV39IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV40IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV41IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV44IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","""{"handler":"E132U2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV26ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV21ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV45Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV29TFCategoriasCategoria","fld":"vTFCATEGORIASCATEGORIA"},{"av":"AV30TFCategoriasCategoria_Sel","fld":"vTFCATEGORIASCATEGORIA_SEL"},{"av":"AV39IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV40IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV41IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV44IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Gridpaginationbar_Rowsperpageselectedvalue","ctrl":"GRIDPAGINATIONBAR","prop":"RowsPerPageSelectedValue"}]""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",""","oparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","""{"handler":"E152U2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV26ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV21ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV45Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV29TFCategoriasCategoria","fld":"vTFCATEGORIASCATEGORIA"},{"av":"AV30TFCategoriasCategoria_Sel","fld":"vTFCATEGORIASCATEGORIA_SEL"},{"av":"AV39IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV40IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV41IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV44IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Ddo_grid_Activeeventkey","ctrl":"DDO_GRID","prop":"ActiveEventKey"},{"av":"Ddo_grid_Selectedcolumn","ctrl":"DDO_GRID","prop":"SelectedColumn"},{"av":"Ddo_grid_Filteredtext_get","ctrl":"DDO_GRID","prop":"FilteredText_get"},{"av":"Ddo_grid_Selectedvalue_get","ctrl":"DDO_GRID","prop":"SelectedValue_get"}]""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED",""","oparms":[{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV29TFCategoriasCategoria","fld":"vTFCATEGORIASCATEGORIA"},{"av":"AV30TFCategoriasCategoria_Sel","fld":"vTFCATEGORIASCATEGORIA_SEL"},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E202U2","iparms":[{"av":"AV39IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV40IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV41IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"cmbavGridactions"},{"av":"AV38GridActions","fld":"vGRIDACTIONS","pic":"ZZZ9"}]}""");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED","""{"handler":"E162U2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV26ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV21ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV45Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV29TFCategoriasCategoria","fld":"vTFCATEGORIASCATEGORIA"},{"av":"AV30TFCategoriasCategoria_Sel","fld":"vTFCATEGORIASCATEGORIA_SEL"},{"av":"AV39IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV40IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV41IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV44IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Ddo_gridcolumnsselector_Columnsselectorvalues","ctrl":"DDO_GRIDCOLUMNSSELECTOR","prop":"ColumnsSelectorValues"}]""");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED",""","oparms":[{"av":"AV21ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV26ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"edtCategoriasCategoria_Visible","ctrl":"CATEGORIASCATEGORIA","prop":"Visible"},{"av":"AV35GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV36GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV37GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV39IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV40IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV41IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV44IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV24ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]}""");
         ...
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED",""","oparms":[{"av":"AV26ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV11GridState","fld":"vGRIDSTATE"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV29TFCategoriasCategoria","fld":"vTFCATEGORIASCATEGORIA"},{"av":"AV30TFCategoriasCategoria_Sel","fld":"vTFCATEGORIASCATEGORIA_SEL"},{"av":"Ddo_grid_Selectedvalue_set","ctrl":"DDO_GRID","prop":"SelectedValue_set"},{"av":"Ddo_grid_Filteredtext_set","ctrl":"DDO_GRID","prop":"FilteredText_set"},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"},{"av":"AV21ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtCategoriasCategoria_Visible","ctrl":"CATEGORIASCATEGORIA","prop":"Visible"},{"av":"AV35GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV36GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV37GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV39IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV40IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV41IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV44IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV24ManageFiltersData","fld":"vMANAGEFILTERSDATA"}]}""");
         setEventMetadata("VGRIDACTIONS.CLICK","""{"handler":"E212U2","iparms":[{"av":"cmbavGridactions"},{"av":"AV38GridActions","fld":"vGRIDACTIONS","pic":"ZZZ9"},{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV26ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV21ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV45Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV29TFCategoriasCategoria","fld":"vTFCATEGORIASCATEGORIA"},{"av":"AV30TFCategoriasCategoria_Sel","fld":"vTFCATEGORIASCATEGORIA_SEL"},{"av":"AV39IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV40IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV41IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV44IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"A20CategoriasId","fld":"CATEGORIASID","pic":"ZZZ9","hsh":true}]""");
         setEventMetadata("VGRIDACTIONS.CLICK",""","oparms":[{"av":"cmbavGridactions"},{"av":"AV38GridActions","fld":"vGRIDACTIONS","pic":"ZZZ9"},{"av":"AV26ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV21ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtCategoriasCategoria_Visible","ctrl":"CATEGORIASCATEGORIA","prop":"Visible"},{"av":"AV35GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV36GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV37GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV39IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV40IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV41IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV44IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV24ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E172U2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV26ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV21ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV45Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV29TFCategoriasCategoria","fld":"vTFCATEGORIASCATEGORIA"},{"av":"AV30TFCategoriasCategoria_Sel","fld":"vTFCATEGORIASCATEGORIA_SEL"},{"av":"AV39IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV40IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV41IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV44IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"A20CategoriasId","fld":"CATEGORIASID","pic":"ZZZ9","hsh":true}]""");
         setEventMetadata("'DOINSERT'",""","oparms":[{"av":"AV26ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV21ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtCategoriasCategoria_Visible","ctrl":"CATEGORIASCATEGORIA","prop":"Visible"},{"av":"AV35GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV36GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV37GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV39IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV40IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV41IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV44IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV24ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED","""{"handler":"E142U2","iparms":[{"av":"Ddo_agexport_Activeeventkey","ctrl":"DDO_AGEXPORT","prop":"ActiveEventKey"},{"av":"AV45Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV11GridState","fld":"vGRIDSTATE"},{"av":"AV30TFCategoriasCategoria_Sel","fld":"vTFCATEGORIASCATEGORIA_SEL"},{"av":"AV29TFCategoriasCategoria","fld":"vTFCATEGORIASCATEGORIA"}]""");
         setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED",""","oparms":[{"av":"Innewwindow1_Target","ctrl":"INNEWWINDOW1","prop":"Target"},{"av":"Innewwindow1_Height","ctrl":"INNEWWINDOW1","prop":"Height"},{"av":"Innewwindow1_Width","ctrl":"INNEWWINDOW1","prop":"Width"},{"av":"AV11GridState","fld":"vGRIDSTATE"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV26ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV21ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV45Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV29TFCategoriasCategoria","fld":"vTFCATEGORIASCATEGORIA"},{"av":"AV30TFCategoriasCategoria_Sel","fld":"vTFCATEGORIASCATEGORIA_SEL"},{"av":"AV39IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV40IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV41IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV44IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"},{"av":"Ddo_grid_Selectedvalue_set","ctrl":"DDO_GRID","prop":"SelectedValue_set"},{"av":"Ddo_grid_Filteredtext_set","ctrl":"DDO_GRID","prop":"FilteredText_set"}]}""");
         setEventMetadata("NULL","""{"handler":"Valid_Categoriascategoria","iparms":[]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         AV42AGExportData = new GXBaseCollection<DesignSystem.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item>( context, "Item", "");
         AV31DDO_TitleSettingsIcons = new DesignSystem.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons(context);
         ...
         AV48Categoriaswwds_3_tfcategoriascategoria_sel = "";
         AV47Categoriaswwds_2_tfcategoriascategoria = "";
         H002U2_A21CategoriasCategoria = new string[] {""} ;
         H002U2_A20CategoriasId = new short[1] ;
         H002U3_AGRID_nRecordCount = new long[1] ;
         AV8HTTPRequest = new GxHttpRequest( context);
         AV43AGExportDataItem = new DesignSystem.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item(context);
         AV32GAMSession = new GeneXus.Programs.genexussecurity.SdtGAMSession(context);
         AV33GAMErrors = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError>( context, "GeneXus.Programs.genexussecurity.SdtGAMError", "DesignSystem.Programs");
         ...
         pr_default = new DataStoreProvider(context, new DesignSystem.Programs.categoriasww__default(),
            new Object[][] {
                new Object[] {
               H002U2_A21CategoriasCategoria, H002U2_A20CategoriasId
               }
               , new Object[] {
      ...
      private int edtCategoriasCategoria_Visible ;
      ...
      private string AV29TFCategoriasCategoria ;
      private string AV30TFCategoriasCategoria_Sel ;
      ...
      private GXBaseCollection<DesignSystem.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item> AV42AGExportData ;
      private DesignSystem.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons AV31DDO_TitleSettingsIcons ;
      private DesignSystem.Programs.wwpbaseobjects.SdtWWPGridState AV11GridState ;
      private IDataStoreProvider pr_default ;
      private string[] H002U2_A21CategoriasCategoria ;
      private short[] H002U2_A20CategoriasId ;
      private long[] H002U3_AGRID_nRecordCount ;
      private DesignSystem.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item AV43AGExportDataItem ;
   ...
   public class categoriasww__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV14OrderedDsc )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV48Categoriaswwds_3_tfcategoriascategoria_sel)) && ! ( StringUtil.StrCmp(AV48Categoriaswwds_3_tfcategoriascategoria_sel, "<#Empty#>") == 0 ) )
         {
         ...
         if ( StringUtil.StrCmp(AV48Categoriaswwds_3_tfcategoriascategoria_sel, "<#Empty#>") == 0 )
         {
         ...
         {
            sOrderString += " ORDER BY `CategoriasCategoria` DESC";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY `CategoriasId`";
         }
                                             ...
                                             bool AV14OrderedDsc )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM `Categorias`";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV46Categoriaswwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( `CategoriasCategoria` like CONCAT('%', @lV46Categoriaswwds_1_filterfulltext)))");
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H002U2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (bool)dynConstraints[4] );
               case 1 :
                     return conditional_H002U3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (bool)dynConstraints[4] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H002U2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002U2,11, GxCacheFrequency.OFF ,true,false )
