                                         ...
                                         GxLocation oLocation )
      {
         ...
         if ( oReader.NodeType == 1 )
         {
            ...
            while ( ! ( ( StringUtil.StrCmp(oReader.Name, sSection) == 0 ) && ( oReader.NodeType == 2 ) ) )
            {
               ...
               {
                  oLocation.Port = (int)(Math.Round(NumberUtil.Val( oReader.Value, "."), 18, MidpointRounding.ToEven));
               }
               ...
               {
                  oLocation.Secure = (short)(Math.Round(NumberUtil.Val( oReader.Value, "."), 18, MidpointRounding.ToEven));
               }
               ...
               {
                  oLocation.ProxyServerPort = (int)(Math.Round(NumberUtil.Val( oReader.Value, "."), 18, MidpointRounding.ToEven));
               }
               else if ( StringUtil.StrCmp(StringUtil.Lower( oReader.Name), "timeout") == 0 )
               {
                  oLocation.Timeout = (short)(Math.Round(NumberUtil.Val( oReader.Value, "."), 18, MidpointRounding.ToEven));
               }
               else if ( StringUtil.StrCmp(StringUtil.Lower( oReader.Name), "cancelonerror") == 0 )
               {
                  oLocation.CancelOnError = (short)(Math.Round(NumberUtil.Val( oReader.Value, "."), 18, MidpointRounding.ToEven));
               }
               else if ( StringUtil.StrCmp(oReader.Name, "Authentication") == 0 )
               {
                  oLocation.Authentication = 1;
                  oLocation.AuthenticationMethod = (short)(Math.Round(NumberUtil.Val( StringUtil.Str( (decimal)(0), 1, 0), "."), 18, MidpointRounding.ToEven));
                  oReader.Read();
                  while ( ! ( ( StringUtil.StrCmp(oReader.Name, "Authentication") == 0 ) && ( oReader.NodeType == 2 ) ) )
                  {
                     ...
                     {
                        oLocation.AuthenticationMethod = (short)(Math.Round(NumberUtil.Val( oReader.Value, "."), 18, MidpointRounding.ToEven));
                     }
               ...
               {
                  oLocation.ProxyAuthenticationMethod = (short)(Math.Round(NumberUtil.Val( StringUtil.Str( (decimal)(0), 1, 0), "."), 18, MidpointRounding.ToEven));
                  oReader.Read();
                  while ( ! ( ( StringUtil.StrCmp(oReader.Name, "Proxyauthentication") == 0 ) && ( oReader.NodeType == 2 ) ) )
                  {
                     ...
                     {
                        oLocation.ProxyAuthenticationMethod = (short)(Math.Round(NumberUtil.Val( oReader.Value, "."), 18, MidpointRounding.ToEven));
                     }
                                        ...
                                        GXXMLReader oReader )
      {
         ...
         if ( oReader.ErrCode == 0 )
         {
            if ( oReader.ReadType(1, "GXLocations") > 0 )
            {
               ...
               while ( ( currError > 0 ) && ! ( ( StringUtil.StrCmp(oReader.Name, "GXLocations") == 0 ) && ( oReader.NodeType == 2 ) ) )
               {
                  if ( ( StringUtil.StrCmp(oReader.Name, "GXLocation") == 0 ) && ( oReader.NodeType == 1 ) )
                  {
                     ...
                     nFirstRead = 1;
                     currError = oReader.Read();
                     while ( ( currError > 0 ) && ! ( ( StringUtil.StrCmp(oReader.Name, "GXLocation") == 0 ) && ( oReader.NodeType == 2 ) ) )
                     {
