...
namespace DesignSystem.Programs {
   public class gamconfiguration : GXDataArea
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20241217053348", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamconfiguration.js", "?20241217053353", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","""{"handler":"E122C2","iparms":[{"av":"cmbavEnabletracing"},{"av":"AV7EnableTracing","fld":"vENABLETRACING","pic":"ZZZ9"},{"av":"AV6EmailRegularExpression","fld":"vEMAILREGULAREXPRESSION"},{"av":"cmbavDefaultrepository"},{"av":"AV5DefaultRepository","fld":"vDEFAULTREPOSITORY"}]}""");
      ...
      public override void initialize( )
      {
         ...
         AV14GAMRepositoryCollection = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMRepository>( context, "GeneXus.Programs.genexussecurity.SdtGAMRepository", "DesignSystem.Programs");
