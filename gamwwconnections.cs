...
namespace DesignSystem.Programs {
   public class gamwwconnections : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV51ManageFiltersExecutionStep, AV45ColumnsSelector, AV75Pgmname, AV11FilName, AV65IsAuthorized_Display, AV66IsAuthorized_Update, AV67IsAuthorized_Delete, AV70IsAuthorized_BtnKeys, AV17IsAuthorized_Name, AV68IsAuthorized_Insert) ;
      ...
      protected void WB1W0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_21_1W2( true) ;
         }
         else
         {
            wb_table1_21_1W2( false) ;
         }
         return  ;
      }

      protected void wb_table1_21_1W2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       DesignSystem.Programs.wwpbaseobjects.SdtWWPColumnsSelector AV45ColumnsSelector ,
                                       string AV75Pgmname ,
                                       string AV11FilName ,
      ...
      protected void E161W2( )
      {
         ...
         new DesignSystem.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "gamconnectionentry_Execute", out  GXt_boolean1) ;
      ...
      protected void E171W2( )
      {
         ...
         /* Refresh Routine */
         returnInSub = false;
         new DesignSystem.Programs.wwpbaseobjects.loadwwpcontext(context ).execute( out  AV28WWPContext) ;
         ...
         edtavName_Visible = (((DesignSystem.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV45ColumnsSelector.gxTpr_Columns.Item(1)).gxTpr_Isvisible ? 1 : 0);
         AssignProp("", false, edtavName_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavName_Visible), 5, 0), !bGXsfl_40_Refreshing);
         edtavUsername_Visible = (((DesignSystem.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV45ColumnsSelector.gxTpr_Columns.Item(2)).gxTpr_Isvisible ? 1 : 0);
         ...
         new DesignSystem.Programs.wwpbaseobjects.wwp_getappliedfiltersdescription(context ).execute(  AV75Pgmname, out  GXt_char3) ;
      ...
      private void E181W2( )
      {
         ...
         AV76GXV1 = 1;
         while ( AV76GXV1 <= AV60GAMConnections.Count )
         {
            AV20RepositoryConnection = ((GeneXus.Programs.genexussecurity.SdtGAMRepositoryConnection)AV60GAMConnections.Item(AV76GXV1));
      ...
      protected void E141W2( )
      {
         ...
         new DesignSystem.Programs.wwpbaseobjects.savecolumnsselectorstate(context ).execute(  "GAMWWConnectionsColumnsSelector",  (String.IsNullOrEmpty(StringUtil.RTrim( AV33ColumnsSelectorXML)) ? "" : AV45ColumnsSelector.ToXml(false, true, "", ""))) ;
      ...
      protected void E111W2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("GAMWWConnectionsFilters")) + "," + UrlEncode(StringUtil.RTrim(AV75Pgmname+"GridState"));
         ...
         else
         {
            ...
            new DesignSystem.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "GAMWWConnectionsFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
            ...
            else
            {
               ...
               S162 ();
               if (returnInSub) return;
               new DesignSystem.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV75Pgmname+"GridState",  AV52ManageFiltersXml) ;
      ...
      protected void S152( )
      {
         ...
         returnInSub = false;
         AV45ColumnsSelector = new DesignSystem.Programs.wwpbaseobjects.SdtWWPColumnsSelector(context);
         new DesignSystem.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV45ColumnsSelector,  "&Name",  "",  "WWP_GAM_Name",  true,  "") ;
         new DesignSystem.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV45ColumnsSelector,  "&UserName",  "",  "WWP_GAM_UserName",  true,  "") ;
         GXt_char3 = AV40UserCustomValue;
         new DesignSystem.Programs.wwpbaseobjects.loadcolumnsselectorstate(context ).execute(  "GAMWWConnectionsColumnsSelector", out  GXt_char3) ;
         ...
         if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV40UserCustomValue)) ) )
         {
            ...
            new DesignSystem.Programs.wwpbaseobjects.wwp_columnselector_updatecolumns(context ).execute( ref  AV61ColumnsSelectorAux, ref  AV45ColumnsSelector) ;
         }
      }
      ...
      protected void S112( )
      {
         ...
         new DesignSystem.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "GAMWWConnectionsFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV50Session.Get(AV75Pgmname+"GridState"), "") == 0 )
         {
            AV31GridState.FromXml(new DesignSystem.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV75Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV31GridState.FromXml(AV50Session.Get(AV75Pgmname+"GridState"), null, "", "");
         }
         /* Execute user subroutine: 'LOADREGFILTERSSTATE' */
         S172 ();
         if (returnInSub) return;
      ...
      protected void S172( )
      {
         ...
         returnInSub = false;
         AV77GXV2 = 1;
         while ( AV77GXV2 <= AV31GridState.gxTpr_Filtervalues.Count )
         {
            AV32GridStateFilterValue = ((DesignSystem.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV31GridState.gxTpr_Filtervalues.Item(AV77GXV2));
      ...
      protected void S142( )
      {
         ...
         new DesignSystem.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV31GridState,  "FILNAME",  context.GetMessage( "WWP_GAM_Name", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV11FilName)),  0,  AV11FilName,  AV11FilName,  false,  "",  "") ;
         ...
         new DesignSystem.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV75Pgmname+"GridState",  AV31GridState.ToXml(false, true, "", "")) ;
      }

      protected void wb_table1_21_1W2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            wb_table2_26_1W2( true) ;
         }
         else
         {
            wb_table2_26_1W2( false) ;
         }
         return  ;
      }

      protected void wb_table2_26_1W2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_21_1W2e( true) ;
         }
         else
         {
            wb_table1_21_1W2e( false) ;
         }
      }

      protected void wb_table2_26_1W2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_26_1W2e( true) ;
         }
         else
         {
            wb_table2_26_1W2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024121623595488", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamwwconnections.js", "?2024121623595497", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"edtavBtnkeys_Title","ctrl":"vBTNKEYS","prop":"Title"},{"av":"AV51ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV45ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV75Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV11FilName","fld":"vFILNAME"},{"av":"AV65IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV66IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV67IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV70IsAuthorized_BtnKeys","fld":"vISAUTHORIZED_BTNKEYS","hsh":true},{"av":"AV17IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true},{"av":"AV68IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"AV51ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV45ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtavName_Visible","ctrl":"vNAME","prop":"Visible"},{"av":"edtavUsername_Visible","ctrl":"vUSERNAME","prop":"Visible"},{"av":"AV58GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV62GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV65IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV66IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV67IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV70IsAuthorized_BtnKeys","fld":"vISAUTHORIZED_BTNKEYS","hsh":true},{"av":"edtavBtnkeys_Visible","ctrl":"vBTNKEYS","prop":"Visible"},{"av":"AV68IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV55ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV31GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E121W2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV51ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV45ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV75Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV11FilName","fld":"vFILNAME"},{"av":"edtavBtnkeys_Title","ctrl":"vBTNKEYS","prop":"Title"},{"av":"AV65IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV66IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV67IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV70IsAuthorized_BtnKeys","fld":"vISAUTHORIZED_BTNKEYS","hsh":true},{"av":"AV17IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true},{"av":"AV68IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E181W2","iparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11FilName","fld":"vFILNAME"},{"av":"AV65IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV66IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV67IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV70IsAuthorized_BtnKeys","fld":"vISAUTHORIZED_BTNKEYS","hsh":true},{"av":"AV17IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"AV13GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV22UserName","fld":"vUSERNAME"},{"av":"AV18Name","fld":"vNAME"},{"av":"cmbavGridactions"},{"av":"AV59GridActions","fld":"vGRIDACTIONS","pic":"ZZZ9"},{"av":"AV69BtnKeys","fld":"vBTNKEYS"},{"av":"edtavBtnkeys_Link","ctrl":"vBTNKEYS","prop":"Link"},{"av":"edtavName_Link","ctrl":"vNAME","prop":"Link"}]}""");
         ...
         setEventMetadata("VGRIDACTIONS.CLICK","""{"handler":"E191W2","iparms":[{"av":"cmbavGridactions"},{"av":"AV59GridActions","fld":"vGRIDACTIONS","pic":"ZZZ9"},{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV51ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV45ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV75Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV11FilName","fld":"vFILNAME"},{"av":"edtavBtnkeys_Title","ctrl":"vBTNKEYS","prop":"Title"},{"av":"AV65IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV66IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV67IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV70IsAuthorized_BtnKeys","fld":"vISAUTHORIZED_BTNKEYS","hsh":true},{"av":"AV17IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true},{"av":"AV68IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"AV18Name","fld":"vNAME"}]""");
      ...
      public override void initialize( )
      {
         ...
         bodyStyle = "";
         GXKey = "";
         AV55ManageFiltersData = new GXBaseCollection<DesignSystem.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item>( context, "Item", "");
         AV62GridAppliedFilters = "";
         AV57DDO_TitleSettingsIcons = new DesignSystem.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons(context);
         ...
         AV28WWPContext = new DesignSystem.Programs.wwpbaseobjects.SdtWWPContext(context);
         ...
         AV60GAMConnections = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMRepositoryConnection>( context, "GeneXus.Programs.genexussecurity.SdtGAMRepositoryConnection", "DesignSystem.Programs");
      ...
      private DesignSystem.Programs.wwpbaseobjects.SdtWWPColumnsSelector AV45ColumnsSelector ;
      private GXBaseCollection<DesignSystem.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item> AV55ManageFiltersData ;
      private DesignSystem.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons AV57DDO_TitleSettingsIcons ;
      ...
      private DesignSystem.Programs.wwpbaseobjects.SdtWWPContext AV28WWPContext ;
