...
namespace DesignSystem.Programs {
   public class gamrecoverpasswordstep1 : GXDataArea
   {
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV25GXV1 = 1;
         while ( AV25GXV1 <= AV6Errors.Count )
         {
            AV22Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV6Errors.Item(AV25GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024121623451260", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamrecoverpasswordstep1.js", "?2024121623451265", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","""{"handler":"E12092","iparms":[{"av":"AV10UserAuthTypeName","fld":"vUSERAUTHTYPENAME","hsh":true},{"av":"AV11UserName","fld":"vUSERNAME"},{"av":"AV7IDP_State","fld":"vIDP_STATE"}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"edtavUsername_Enabled","ctrl":"vUSERNAME","prop":"Enabled"}]}""");
         setEventMetadata("BACKTOLOGIN.CLICK","""{"handler":"E13092","iparms":[{"av":"AV7IDP_State","fld":"vIDP_STATE"}]""");
