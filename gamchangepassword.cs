   ...
   public class gamchangepassword : GXHttpHandler
   {
      ...
      protected void WB060( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 CellMarginTop", "Center", "top", "", "", "div");
            wb_table1_21_062( true) ;
         }
         else
         {
            wb_table1_21_062( false) ;
         }
         return  ;
      }

      protected void wb_table1_21_062e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "Center", "top", "div");
      ...
      protected void E11062( )
      {
         ...
         AV31User = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getusertochangepassword();
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV31User.gxTpr_Name)) )
         {
            AV10UserName = AV31User.gxTpr_Name;
            AssignAttri("", false, "AV10UserName", AV10UserName);
         }
         else
         {
            AV30Errors = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getlasterrors();
      ...
      protected void E12062( )
      {
         ...
         {
            AV7isOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).updateusertochangepassword(AV11UserPassword, AV12UserPasswordNew, out  AV30Errors);
            if ( AV7isOK )
            {
      ...
      protected void E13062( )
      {
         ...
         returnInSub = false;
         AV7isOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).logout(out  AV30Errors);
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV34GXV1 = 1;
         while ( AV34GXV1 <= AV30Errors.Count )
         {
            AV29Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV30Errors.Item(AV34GXV1));
            GX_msglist.addItem(StringUtil.Format( "%1 (GAM%2)", AV29Error.gxTpr_Message, StringUtil.LTrimStr( (decimal)(AV29Error.gxTpr_Code), 12, 0), "", "", "", "", "", "", ""));
      ...
      protected void wb_table1_21_062( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table1_21_062e( true) ;
         }
         else
         {
            wb_table1_21_062e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202412162344265", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamchangepassword.js", "?202412162344273", false, true);
         context.AddJavascriptSource("DVelop/DVMessage/pnotify.custom.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVMessage/DVMessageRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","""{"handler":"E12062","iparms":[{"av":"AV12UserPasswordNew","fld":"vUSERPASSWORDNEW"},{"av":"AV13UserPasswordNewConf","fld":"vUSERPASSWORDNEWCONF"},{"av":"AV11UserPassword","fld":"vUSERPASSWORD"},{"av":"AV6IDP_State","fld":"vIDP_STATE","hsh":true}]}""");
         setEventMetadata("BACKTOLOGIN.CLICK","""{"handler":"E13062","iparms":[]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         AV31User = new GeneXus.Programs.genexussecurity.SdtGAMUser(context);
         AV30Errors = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError>( context, "GeneXus.Programs.genexussecurity.SdtGAMError", "DesignSystem.Programs");
         AV8URL = "";
         AV29Error = new GeneXus.Programs.genexussecurity.SdtGAMError(context);
         sStyleString = "";
      ...
      private GeneXus.Programs.genexussecurity.SdtGAMUser AV31User ;
      private GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError> AV30Errors ;
      private GeneXus.Programs.genexussecurity.SdtGAMError AV29Error ;
