   ...
   public class gamsecuritypolicyentry : GXDataArea
   {
      ...
      protected void E121J2( )
      {
         ...
         else
         {
            ...
            AV32GXV1 = 1;
            while ( AV32GXV1 <= AV6Errors.Count )
            {
               AV5Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV6Errors.Item(AV32GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024121623551739", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamsecuritypolicyentry.js", "?2024121623551739", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_onlysd_Cls = "DVBootstrapResponsivePanel";
         ...
         Dvpanel_onlyweb_Cls = "DVBootstrapResponsivePanel";
      ...
      public override void initialize( )
      {
         ...
         pr_gam = new DataStoreProvider(context, new DesignSystem.Programs.gamsecuritypolicyentry__gam(),
            new Object[][] {
            }
         );
         pr_default = new DataStoreProvider(context, new DesignSystem.Programs.gamsecuritypolicyentry__default(),
            new Object[][] {
            }
         );
         /* GeneXus formulas. */
