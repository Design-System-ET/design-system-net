...
namespace DesignSystem.Programs.wwpbaseobjects {
   public class wizardstepsprogresswc : GXWebComponent
   {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(GXBaseCollection<DesignSystem.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>)AV9WizardSteps,(string)AV6CurrentStep});
                  componentstart();
      ...
      protected void E110W2( )
      {
         ...
         {
            AV5WizardStep = ((DesignSystem.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV9WizardSteps.Item(AV12GXV1));
      ...
      private void E120W2( )
      {
         ...
         {
            AV9WizardSteps.CurrentItem = ((DesignSystem.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV9WizardSteps.Item(AV13GXV2));
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV9WizardSteps = (GXBaseCollection<DesignSystem.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>)getParm(obj,0);
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         {
            AV9WizardSteps = (GXBaseCollection<DesignSystem.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>)getParm(obj,2);
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            AV9WizardSteps = new GXBaseCollection<DesignSystem.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>();
         }
         else
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202412162336636", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/wizardstepsprogresswc.js", "?202412162336637", false, true);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDWIZARDSTEPS.LOAD","""{"handler":"E120W2","iparms":[{"av":"AV8StepNumber","fld":"vSTEPNUMBER","pic":"ZZZ9","hsh":true},{"av":"AV7SelectedStepNumber","fld":"vSELECTEDSTEPNUMBER","pic":"ZZZ9","hsh":true}]""");
      ...
      {
         AV9WizardSteps = new GXBaseCollection<DesignSystem.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>( context, "WizardStepsItem", "DesignSystem");
         wcpOAV6CurrentStep = "";
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         sPrefix = "";
      ...
      private GXBaseCollection<DesignSystem.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem> AV9WizardSteps ;
