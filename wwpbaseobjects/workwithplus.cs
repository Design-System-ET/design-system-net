...
namespace DesignSystem.Programs.wwpbaseobjects {
   public class workwithplus : GXMasterPage
   {
      public workwithplus( )
      {
      ...
      public workwithplus( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            if ( ( GxWebError == 0 ) && ! isAjaxCallMode( ) )
            {
               ...
               AssignProp("", true, edtavCaption_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavCaption_Enabled), 5, 0), !bGXsfl_84_Refreshing);
               WS2O2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  WE2O2( ) ;
      ...
      protected void RenderHtmlCloseForm2O2( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/workwithplus.js", "?2024121707974", false, true);
      ...
      {
         return "WWPBaseObjects.WorkWithPlus" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Work With Plus", "") ;
      }
      ...
      protected void WB2O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_bitmap( context, imgLogoheader_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" ", "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_WWPBaseObjects/WorkWithPlus.htm");
            ...
            StyleString = "";
            sImgUrl = (string)(context.GetImagePath( "e9edf59f-db45-4e16-b6a6-2c2b6611a4a3", "", context.GetTheme( )));
            GxWebStd.gx_bitmap( context, imgLogoforstickymenu_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" ", "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_WWPBaseObjects/WorkWithPlus.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            wb_table1_24_2O2( true) ;
         }
         else
         {
            wb_table1_24_2O2( false) ;
         }
         return  ;
      }

      protected void wb_table1_24_2O2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTabletitlecell_Internalname, divTabletitlecell_Visible, 0, "px", 0, "px", "col-xs-12 CellTitleMasterLandingPurus", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTabletitle_Internalname, divTabletitle_Visible, 0, "px", 0, "px", "Table", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblocktitle_Internalname, lblTextblocktitle_Caption, "", "", lblTextblocktitle_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "TextBlockTitleMaster", 0, "", 1, 1, 0, 0, "HLP_WWPBaseObjects/WorkWithPlus.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSubtitle_Internalname, lblSubtitle_Caption, "", "", lblSubtitle_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "TextBlock", 0, "", 1, 1, 0, 1, "HLP_WWPBaseObjects/WorkWithPlus.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtable6_Internalname, 1, 0, "px", 0, "px", "TableHeaderLandingPurus", "start", "top", " "+"data-gx-flex"+" ", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "CellTableContentHorizontalMenu", "start", "top", "", "flex-grow:1;", "div");
            if ( context.isSpaRequest( ) )
            {
               enableOutput();
            }
            ...
            /* Static images/pictures */
            ClassString = "Image" + " " + ((StringUtil.StrCmp(imgGenexus_gximage, "")==0) ? "GX_Image_genexus_Class" : "GX_Image_"+imgGenexus_gximage+"_Class");
            StyleString = "";
            sImgUrl = (string)(context.GetImagePath( "4f34a868-a429-4e5a-8793-1f91da6c6370", "", context.GetTheme( )));
            GxWebStd.gx_bitmap( context, imgGenexus_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" ", "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_WWPBaseObjects/WorkWithPlus.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divFootercell_Internalname, divFootercell_Visible, 0, "px", 0, "px", "col-xs-12 FooterBlackCell", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divFooter_Internalname, 1, 0, "px", 0, "px", "Flex", "start", "top", " "+"data-gx-flex"+" ", "flex-wrap:wrap;justify-content:center;", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Static images/pictures */
            ClassString = "LandingPurusMoreInfoContact" + " " + ((StringUtil.StrCmp(imgMoreinfocontact_gximage, "")==0) ? "GX_Image_MoreInfoContact_Class" : "GX_Image_"+imgMoreinfocontact_gximage+"_Class");
            StyleString = "";
            sImgUrl = (string)(context.GetImagePath( "e89258bc-c8ec-4c38-8a4f-7b6e207569dc", "", context.GetTheme( )));
            GxWebStd.gx_bitmap( context, imgMoreinfocontact_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" ", "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_WWPBaseObjects/WorkWithPlus.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblContacttitle_Internalname, context.GetMessage( "Contacto", ""), "", "", lblContacttitle_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "LandingPurusFooterTitle", 0, "", 1, 1, 0, 0, "HLP_WWPBaseObjects/WorkWithPlus.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblAddress1_Internalname, context.GetMessage( "Chuy - Rocha", ""), "", "", lblAddress1_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "LandingPurusFooterText", 0, "", 1, 1, 0, 0, "HLP_WWPBaseObjects/WorkWithPlus.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTelephone_Internalname, "+598 91 388 175", "", "", lblTelephone_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "LandingPurusFooterText", 0, "", 1, 1, 0, 0, "HLP_WWPBaseObjects/WorkWithPlus.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblEmail_Internalname, context.GetMessage( "design-system@gmail.com", ""), "", "", lblEmail_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "LandingPurusFooterText", 0, "", 1, 1, 0, 0, "HLP_WWPBaseObjects/WorkWithPlus.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblFormcontact_Internalname, context.GetMessage( "Formulario Contacto", ""), "", "", lblFormcontact_Jsonclick, "'"+""+"'"+",true,"+"'"+"ECONTACTO_MPAGE."+"'", "", "LandingPurusFooterText", 5, "", 1, 1, 0, 0, "HLP_WWPBaseObjects/WorkWithPlus.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSitemaptitle_Internalname, context.GetMessage( "Mapa del sitio", ""), "", "", lblSitemaptitle_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "LandingPurusFooterTitle", 0, "", 1, 1, 0, 0, "HLP_WWPBaseObjects/WorkWithPlus.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         ...
         if ( ( wbEnd == 84 ) && ( ! context.isPopUpObject( ) || ShowMPWhenPopUp( ) ) )
         {
            wbEnd = 0;
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblFollowustitle_Internalname, context.GetMessage( "¡Síguenos!", ""), "", "", lblFollowustitle_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "LandingPurusFooterTitle", 0, "", 1, 1, 0, 0, "HLP_WWPBaseObjects/WorkWithPlus.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblUafacebook_Internalname, context.GetMessage( "<i class=\"fab fa-facebook-f LandingPurusFontIconFooter\"></i>", ""), "", "", lblUafacebook_Jsonclick, "'"+""+"'"+",true,"+"'"+"EDOUAFACEBOOK_MPAGE."+"'", "", "TextBlock", 5, "", 1, 1, 0, 1, "HLP_WWPBaseObjects/WorkWithPlus.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblUainstagram_Internalname, context.GetMessage( "<i class=\"fab fa-instagram LandingPurusFontIconFooter\"></i>", ""), "", "", lblUainstagram_Jsonclick, "'"+""+"'"+",true,"+"'"+"EDOUAINSTAGRAM_MPAGE."+"'", "", "TextBlock", 5, "", 1, 1, 0, 1, "HLP_WWPBaseObjects/WorkWithPlus.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblUalinkedin_Internalname, context.GetMessage( "<i class=\"fab fa-linkedin LandingPurusFontIconFooter\"></i>", ""), "", "", lblUalinkedin_Jsonclick, "'"+""+"'"+",true,"+"'"+"EDOUALINKEDIN_MPAGE."+"'", "", "TextBlock", 5, "", 1, 1, 0, 1, "HLP_WWPBaseObjects/WorkWithPlus.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblUawhatsapp_Internalname, context.GetMessage( "<i class=\"fab fa-whatsapp LandingPurusFontIconFooter\"></i>", ""), "", "", lblUawhatsapp_Jsonclick, "'"+""+"'"+",true,"+"'"+"EDOUAWHATSAPP_MPAGE."+"'", "", "TextBlock", 5, "", 1, 1, 0, 1, "HLP_WWPBaseObjects/WorkWithPlus.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 122,'',true,'" + sGXsfl_84_idx + "',0)\"";
            ...
            GxWebStd.gx_single_line_edit( context, edtavPickerdummyvariable_Internalname, context.localUtil.Format(AV33PickerDummyVariable, "99/99/99"), context.localUtil.Format( AV33PickerDummyVariable, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'"+context.GetLanguageProperty( "date_fmt")+"',0,"+context.GetLanguageProperty( "time_fmt")+",'"+context.GetLanguageProperty( "code")+"',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'"+context.GetLanguageProperty( "date_fmt")+"',0,"+context.GetLanguageProperty( "time_fmt")+",'"+context.GetLanguageProperty( "code")+"',false,0);"+";gx.evt.onblur(this,122);\"", "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "", "", "", edtavPickerdummyvariable_Jsonclick, 0, "Invisible", "", "", "", "", 1, 1, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WWPBaseObjects/WorkWithPlus.htm");
            GxWebStd.gx_bitmap( context, edtavPickerdummyvariable_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(1==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_WWPBaseObjects/WorkWithPlus.htm");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "MPW0124"+"", StringUtil.RTrim( WebComp_Wwpaux_wc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpMPW0124"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( bGXsfl_84_Refreshing )
               {
                  if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
                  {
                     if ( StringUtil.StrCmp(StringUtil.Lower( OldWwpaux_wc), StringUtil.Lower( WebComp_Wwpaux_wc_Component)) != 0 )
                     {
                        context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpMPW0124"+"");
                     }
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                  {
                     ...
                     if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                     {
                        ...
                        else if ( StringUtil.StrCmp(sEvt, "DOUAFACEBOOK_MPAGE") == 0 )
                        {
                           context.wbHandled = 1;
                           dynload_actions( ) ;
                        }
                        else if ( StringUtil.StrCmp(sEvt, "DOUAINSTAGRAM_MPAGE") == 0 )
                        {
                           context.wbHandled = 1;
                           dynload_actions( ) ;
                        }
                        else if ( StringUtil.StrCmp(sEvt, "DOUALINKEDIN_MPAGE") == 0 )
                        {
                           context.wbHandled = 1;
                           dynload_actions( ) ;
                        }
                        else if ( StringUtil.StrCmp(sEvt, "DOUAWHATSAPP_MPAGE") == 0 )
                        {
                           context.wbHandled = 1;
                           dynload_actions( ) ;
                        }
                     ...
                     else
                     {
                        ...
                        if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 11), "START_MPAGE") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 26), "FSSITEMAP_MPAGE.LOAD_MPAGE") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "REFRESH_MPAGE") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 11), "ENTER_MPAGE") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 12), "CANCEL_MPAGE") == 0 ) )
                        {
                           ...
                           GXCCtl = "FORM_MPAGE_Caption_" + sGXsfl_84_idx;
                           (getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Caption = cgiGet( GXCCtl);
                  ...
                  else if ( StringUtil.StrCmp(sEvtType, "M") == 0 )
                  {
                     ...
                     if ( nCmpId == 124 )
                     {
                        ...
                        if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
                        {
                           WebComp_Wwpaux_wc.componentprocess("MPW0124", "", sEvt);
                        }
                        WebComp_Wwpaux_wc_Component = OldWwpaux_wc;
                     }
                  }
      ...
      protected void gxnrFssitemap_newrow( )
      {
         ...
         {
            sendrow_842( ) ;
            nGXsfl_84_idx = ((subFssitemap_Islastpage==1)&&(nGXsfl_84_idx+1>subFssitemap_fnc_Recordsperpage( )) ? 1 : nGXsfl_84_idx+1);
            sGXsfl_84_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_84_idx), 4, 0), 4, "0");
            SubsflControlProps_842( ) ;
         }
      ...
      protected void E152O2( )
      {
         /* Start Routine */
         returnInSub = false;
         divTabletitle_Visible = 0;
         AssignProp("", true, divTabletitle_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(divTabletitle_Visible), 5, 0), true);
         ...
         AV34GXV1 = 1;
         while ( AV34GXV1 <= AV5GAMRoleCollection.Count )
         {
            AV6GAMRole = ((GeneXus.Programs.genexussecurity.SdtGAMRole)AV5GAMRoleCollection.Item(AV34GXV1));
      ...
      private void E162O2( )
      {
         ...
         AV13CountItems = 1;
         AV35GXV2 = 1;
         while ( AV35GXV2 <= AV23DVelop_Menu.Count )
         {
            AV10DVelop_Menu_Item = ((DesignSystem.Programs.wwpbaseobjects.SdtDVelop_Menu_Item)AV23DVelop_Menu.Item(AV35GXV2));
            if ( AV13CountItems <= AV14MaxItemsToDisplay )
            {
               ...
               {
                  DoAjaxLoad(84, FssitemapRow);
               }
               AV13CountItems = (short)(AV13CountItems+1);
               AV36GXV3 = 1;
               while ( AV36GXV3 <= AV10DVelop_Menu_Item.gxTpr_Subitems.Count )
               {
                  AV11DVelop_Menu_SubItem = ((DesignSystem.Programs.wwpbaseobjects.SdtDVelop_Menu_Item)AV10DVelop_Menu_Item.gxTpr_Subitems.Item(AV36GXV3));
                  if ( AV13CountItems <= AV14MaxItemsToDisplay )
                  {
      ...
      protected void E112O2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"MPW0124",(string)""});
      ...
      protected void E122O2( )
      {
         ...
         {
            WebComp_Wwpaux_wc.setjustcreated();
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"MPW0124",(string)"",(string)AV19Search});
      ...
      protected void E172O2( )
      {
         ...
         lblSubtitle_Caption = (String.IsNullOrEmpty(StringUtil.RTrim( AV26Breadcrumb)) ? StringUtil.Format( "<span class=\"%2\">%1</span>", Contentholder.Pgmdesc, "BreadCrumb", "", "", "", "", "", "", "") : AV26Breadcrumb);
      ...
      protected void wb_table1_24_2O2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 28,'',true,'" + sGXsfl_84_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavSearch_Internalname, AV19Search, StringUtil.RTrim( context.localUtil.Format( AV19Search, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,28);\"", "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "", "", context.GetMessage( "WWP_MasterPage_Search", ""), edtavSearch_Jsonclick, 0, "AttributeSearch", "", "", "", "", 1, edtavSearch_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWPBaseObjects/WorkWithPlus.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblActionsearch_Internalname, context.GetMessage( "<i class=\"fas fa-search ImageSearchIcon\"></i>", ""), "", "", lblActionsearch_Jsonclick, "'"+""+"'"+",true,"+"'"+"EDOACTIONSEARCH_MPAGE."+"'", "", "TextBlock", 5, "", 1, lblActionsearch_Enabled, 1, 1, "HLP_WWPBaseObjects/WorkWithPlus.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_24_2O2e( true) ;
         }
         else
         {
            wb_table1_24_2O2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?2024121707194", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wwpbaseobjects/workwithplus.js", "?2024121707196", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/slimmenu/jquery.slimmenu.min.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVHorizontalMenu/DVHorizontalMenuRender.js", "", false, true);
      ...
      {
         edtavCaption_Internalname = "vCAPTION_MPAGE_"+sGXsfl_84_idx;
      }

      protected void SubsflControlProps_fel_842( )
      {
         edtavCaption_Internalname = "vCAPTION_MPAGE_"+sGXsfl_84_fel_idx;
      }
      ...
      protected void sendrow_842( )
      {
         ...
         else if ( subFssitemap_Backcolorstyle == 3 )
         {
            ...
            {
               subFssitemap_Backcolor = (int)(0x0);
               if ( StringUtil.StrCmp(subFssitemap_Class, "") != 0 )
               {
                  subFssitemap_Linesclass = subFssitemap_Class+"Even";
               }
            }
            else
            {
         ...
         if ( MPFssitemapContainer.GetWrapped() == 1 )
         {
            context.WriteHtmlText( "<tr"+" class=\""+subFssitemap_Linesclass+"\" style=\""+""+"\""+" data-gxrow=\""+sGXsfl_84_idx+"\">") ;
         }
         /* Table start */
         FssitemapRow.AddColumnProperties("table", -1, isAjaxCallMode( ), new Object[] {(string)tblUnnamedtablefsfssitemap_Internalname+"_"+sGXsfl_84_idx,(short)1,(string)"Table",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(short)2,(string)"",(string)"",(string)"",(string)"px",(string)"px",(string)""});
         ...
         GXCCtl = "vDVELOP_MENU_MPAGE_" + sGXsfl_84_idx;
         if ( context.isAjaxRequest( ) )
         {
         ...
         GXCCtl = "vSEARCHAUX_MPAGE_" + sGXsfl_84_idx;
         GxWebStd.gx_hidden_field( context, GXCCtl, AV15SearchAux);
         GXCCtl = "vBREADCRUMB_MPAGE_" + sGXsfl_84_idx;
         GxWebStd.gx_hidden_field( context, GXCCtl, AV26Breadcrumb);
         GXCCtl = "FORM_MPAGE_Caption_" + sGXsfl_84_idx;
         GxWebStd.gx_hidden_field( context, GXCCtl, StringUtil.RTrim( (getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Caption));
         GXCCtl = "FORM_MPAGE_Caption_" + sGXsfl_84_idx;
         GxWebStd.gx_hidden_field( context, GXCCtl, StringUtil.RTrim( (getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Caption));
      ...
      protected void StartGridControl84( )
      {
         if ( MPFssitemapContainer.GetWrapped() == 1 )
         {
            context.WriteHtmlText( "<div id=\""+"MPFssitemapContainer"+"DivS\" data-gxgridid=\"84\">") ;
            sStyleString = "";
      ...
      protected void init_default_properties( )
      {
         ...
         tblUnnamedtable7_Internalname = "UNNAMEDTABLE7_MPAGE";
         ...
         imgGenexus_Internalname = "GENEXUS_MPAGE";
         divUnnamedtable6_Internalname = "UNNAMEDTABLE6_MPAGE";
      ...
      public override void initialize_properties( )
      {
         ...
         divFootercell_Visible = 1;
         lblSubtitle_Caption = context.GetMessage( "Developer Menu > Person", "");
         lblTextblocktitle_Caption = context.GetMessage( " Title", "");
         divTabletitle_Visible = 1;
         divTabletitlecell_Visible = 1;
         divToprightfixedelements_Class = "ElementInStickyMenuHeaderCell TopRightFixedHeader";
         divTableheadercell_Class = "col-xs-12 HorizontalStickyMenuHeaderCell MasterHeaderCellNoBackground CellPaddingLeftRight0XS CellPaddingTop";
      ...
      {
         setEventMetadata("REFRESH_MPAGE","""{"handler":"Refresh","iparms":[{"av":"FSSITEMAP_MPAGE_nFirstRecordOnPage"},{"av":"FSSITEMAP_MPAGE_nEOF"},{"ctrl":"FORM_MPAGE","prop":"Caption"},{"av":"AV23DVelop_Menu","fld":"vDVELOP_MENU_MPAGE"},{"av":"AV26Breadcrumb","fld":"vBREADCRUMB_MPAGE","hsh":true}]""");
         setEventMetadata("REFRESH_MPAGE",""","oparms":[{"av":"lblTextblocktitle_Caption","ctrl":"TEXTBLOCKTITLE_MPAGE","prop":"Caption"},{"av":"AV26Breadcrumb","fld":"vBREADCRUMB_MPAGE","hsh":true},{"av":"lblSubtitle_Caption","ctrl":"SUBTITLE_MPAGE","prop":"Caption"},{"av":"divTableheadercell_Class","ctrl":"TABLEHEADERCELL_MPAGE","prop":"Class"},{"av":"divToprightfixedelements_Class","ctrl":"TOPRIGHTFIXEDELEMENTS_MPAGE","prop":"Class"},{"av":"divTabletitlecell_Visible","ctrl":"TABLETITLECELL_MPAGE","prop":"Visible"},{"av":"divFootercell_Visible","ctrl":"FOOTERCELL_MPAGE","prop":"Visible"}]}""");
         setEventMetadata("FSSITEMAP_MPAGE.LOAD_MPAGE","""{"handler":"E162O2","iparms":[{"av":"AV23DVelop_Menu","fld":"vDVELOP_MENU_MPAGE"}]""");
         ...
         setEventMetadata("DDC_ADMINAG_MPAGE.ONLOADCOMPONENT_MPAGE","""{"handler":"E112O2","iparms":[]""");
         setEventMetadata("DDC_ADMINAG_MPAGE.ONLOADCOMPONENT_MPAGE",""","oparms":[{"ctrl":"WWPAUX_WC_MPAGE"}]}""");
         setEventMetadata("DOACTIONSEARCH_MPAGE","""{"handler":"E132O2","iparms":[{"av":"AV15SearchAux","fld":"vSEARCHAUX_MPAGE"}]}""");
         setEventMetadata("POPOVER_SEARCH_MPAGE.ONLOADCOMPONENT_MPAGE","""{"handler":"E122O2","iparms":[{"av":"AV19Search","fld":"vSEARCH_MPAGE"}]""");
         ...
         setEventMetadata("CONTACTO_MPAGE","""{"handler":"E142O2","iparms":[]}""");
      ...
      private int divTabletitle_Visible ;
      ...
      private string imgGenexus_gximage ;
      private string imgGenexus_Internalname ;
