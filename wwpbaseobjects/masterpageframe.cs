...
namespace DesignSystem.Programs.wwpbaseobjects {
   public class masterpageframe : GXMasterPage
   {
      ...
      protected void RenderHtmlCloseForm0I2( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/masterpageframe.js", "?202412162348282", false, true);
      ...
      protected void E110I2( )
      {
         ...
         if ( StringUtil.StrCmp(AV7Httprequest.Method, "GET") == 0 )
         {
            ...
            new DesignSystem.Programs.wwpbaseobjects.wwp_getdesignsystemsettings(context ).execute( out  GXt_SdtWWP_DesignSystemSettings1) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?202412162348367", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/masterpageframe.js", "?202412162348368", false, true);
            context.AddJavascriptSource("DVelop/DVMessage/pnotify.custom.js", "", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            context.AddJavascriptSource("DVelop/DVMessage/DVMessageRender.js", "", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         AV5WWP_DesignSystemSettings = new DesignSystem.Programs.wwpbaseobjects.SdtWWP_DesignSystemSettings(context);
         GXt_SdtWWP_DesignSystemSettings1 = new DesignSystem.Programs.wwpbaseobjects.SdtWWP_DesignSystemSettings(context);
      ...
      private DesignSystem.Programs.wwpbaseobjects.SdtWWP_DesignSystemSettings AV5WWP_DesignSystemSettings ;
      private DesignSystem.Programs.wwpbaseobjects.SdtWWP_DesignSystemSettings GXt_SdtWWP_DesignSystemSettings1 ;
