...
namespace DesignSystem.Programs.wwpbaseobjects
{
	...
	[XmlType(TypeName="Item" , Namespace="DesignSystem" )]
	[Serializable]
	public class SdtDVelop_Menu_Item : GxUserType
	{
		...
		public GXBaseCollection<DesignSystem.Programs.wwpbaseobjects.SdtDVelop_Menu_Item> gxTpr_Subitems_GXBaseCollection
		{
			get {
				if ( gxTv_SdtDVelop_Menu_Item_Subitems == null )
				{
					gxTv_SdtDVelop_Menu_Item_Subitems = new GXBaseCollection<DesignSystem.Programs.wwpbaseobjects.SdtDVelop_Menu_Item>( context, "DVelop_Menu", "");
				}
		...
		[XmlIgnore]
		public GXBaseCollection<DesignSystem.Programs.wwpbaseobjects.SdtDVelop_Menu_Item> gxTpr_Subitems
		{
			get {
				if ( gxTv_SdtDVelop_Menu_Item_Subitems == null )
				{
		...
		protected GXBaseCollection<DesignSystem.Programs.wwpbaseobjects.SdtDVelop_Menu_Item> gxTv_SdtDVelop_Menu_Item_Subitems = null;  
	...
	[DataContract(Name=@"Item", Namespace="DesignSystem")]
	public class SdtDVelop_Menu_Item_RESTInterface : GxGenericCollectionItem<SdtDVelop_Menu_Item>, System.Web.SessionState.IRequiresSessionState
	{
		...
		public  GxGenericCollection<DesignSystem.Programs.wwpbaseobjects.SdtDVelop_Menu_Item_RESTInterface> gxTpr_Subitems
		{
			get { 
				if (sdt.ShouldSerializegxTpr_Subitems_GXBaseCollection_Json())
					return new GxGenericCollection<DesignSystem.Programs.wwpbaseobjects.SdtDVelop_Menu_Item_RESTInterface>(sdt.gxTpr_Subitems);
				else
					return null;
