...
namespace DesignSystem.Programs.wwpbaseobjects {
   public class workwithplusmasterpageprompt : GXMasterPage
   {
      ...
      protected void RenderHtmlCloseForm0F2( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/workwithplusmasterpageprompt.js", "?2024121623474521", false, true);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?2024121623474629", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/workwithplusmasterpageprompt.js", "?2024121623474630", false, true);
            context.AddJavascriptSource("DVelop/DVMessage/pnotify.custom.js", "", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            context.AddJavascriptSource("DVelop/DVMessage/DVMessageRender.js", "", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         AV6WWP_DesignSystemSettings = new DesignSystem.Programs.wwpbaseobjects.SdtWWP_DesignSystemSettings(context);
      ...
      private DesignSystem.Programs.wwpbaseobjects.SdtWWP_DesignSystemSettings AV6WWP_DesignSystemSettings ;
