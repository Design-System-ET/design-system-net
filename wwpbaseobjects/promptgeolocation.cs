   ...
   public class promptgeolocation : GXHttpHandler
   {
      ...
      protected void wb_table1_2_0P2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_8_0P2( true) ;
         }
         else
         {
            wb_table2_8_0P2( false) ;
         }
         return  ;
      }

      protected void wb_table2_8_0P2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table2_8_0P2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_8_0P2e( true) ;
         }
         else
         {
            wb_table2_8_0P2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202412162349529", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/promptgeolocation.js", "?202412162349529", false, true);
         context.AddJavascriptSource("GXGoogleVisualizationLibrary/MAP/mapsproviders.js", "", false, true);
         context.AddJavascriptSource("https://unpkg.com/@googlemaps/markerclusterer/dist/index.min.js", "", false, true);
         context.AddJavascriptSource("GXGoogleVisualizationLibrary/MAP/Gxmap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","""{"handler":"E120P2","iparms":[{"av":"AV10Latitude","fld":"vLATITUDE"},{"av":"AV7Geolocation","fld":"vGEOLOCATION"},{"av":"AV11Longitude","fld":"vLONGITUDE"}]""");
