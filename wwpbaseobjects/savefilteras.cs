...
namespace DesignSystem.Programs.wwpbaseobjects {
   public class savefilteras : GXDataArea
   {
      ...
      protected void S112( )
      {
         ...
         {
            GX_msglist.addItem(new DesignSystem.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "WWP_FiltersName", ""), "", "", "", "", "", "", "", ""),  "error",  edtavFiltername_Internalname,  "true",  ""));
      ...
      protected void E120Q2( )
      {
         ...
         {
            AV10GridStateCollection.FromXml(new DesignSystem.Programs.wwpbaseobjects.loadmanagefiltersstate(context).executeUdp(  AV15UserKey), null, "Items", "");
            AV12IsNameUnique = true;
            AV23GXV1 = 1;
            while ( AV23GXV1 <= AV10GridStateCollection.Count )
            {
               AV11GridStateCollectionItem = ((DesignSystem.Programs.wwpbaseobjects.SdtGridStateCollection_Item)AV10GridStateCollection.Item(AV23GXV1));
            ...
            if ( AV12IsNameUnique )
            {
               AV11GridStateCollectionItem = new DesignSystem.Programs.wwpbaseobjects.SdtGridStateCollection_Item(context);
               ...
               new DesignSystem.Programs.wwpbaseobjects.savemanagefiltersstate(context ).execute(  AV15UserKey,  AV10GridStateCollection.ToXml(false, true, "Items", "")) ;
            ...
            {
               GX_msglist.addItem(new DesignSystem.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  context.GetMessage( "Name must be unique", ""),  "error",  edtavFiltername_Internalname,  "true",  ""));
            }
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024121623492739", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/savefilteras.js", "?2024121623492740", false, true);
         context.AddJavascriptSource("DVelop/DVMessage/pnotify.custom.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVMessage/DVMessageRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","""{"handler":"E120Q2","iparms":[{"av":"AV8FilterName","fld":"vFILTERNAME"},{"av":"AV20CheckRequiredFieldsResult","fld":"vCHECKREQUIREDFIELDSRESULT"},{"av":"AV15UserKey","fld":"vUSERKEY","hsh":true},{"av":"AV5GridStateKey","fld":"vGRIDSTATEKEY","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         AV8FilterName = "";
         AV10GridStateCollection = new GXBaseCollection<DesignSystem.Programs.wwpbaseobjects.SdtGridStateCollection_Item>( context, "Item", "");
         AV11GridStateCollectionItem = new DesignSystem.Programs.wwpbaseobjects.SdtGridStateCollection_Item(context);
      ...
      private GXBaseCollection<DesignSystem.Programs.wwpbaseobjects.SdtGridStateCollection_Item> AV10GridStateCollection ;
      private DesignSystem.Programs.wwpbaseobjects.SdtGridStateCollection_Item AV11GridStateCollectionItem ;
