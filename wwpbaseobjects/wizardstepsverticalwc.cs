...
namespace DesignSystem.Programs.wwpbaseobjects {
   public class wizardstepsverticalwc : GXWebComponent
   {
      ...
      protected void gxgrGridwizardsteps_refresh( GXBaseCollection<DesignSystem.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem> AV18WizardSteps ,
      ...
      private void E120T2( )
      {
         ...
         {
            AV5WizardStep = ((DesignSystem.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV18WizardSteps.Item(AV26GXV2));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024121623362713", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/wizardstepsverticalwc.js", "?2024121623362714", false, true);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDWIZARDSTEPS.LOAD","""{"handler":"E120T2","iparms":[{"av":"AV18WizardSteps","fld":"vWIZARDSTEPS"},{"av":"AV15StepNumber","fld":"vSTEPNUMBER","pic":"ZZZ9","hsh":true},{"av":"AV13SelectedStepNumber","fld":"vSELECTEDSTEPNUMBER","pic":"ZZZ9","hsh":true}]""");
