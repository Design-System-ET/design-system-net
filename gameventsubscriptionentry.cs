   ...
   public class gameventsubscriptionentry : GXDataArea
   {
      ...
      protected void E12272( )
      {
         ...
         else
         {
            ...
            AV20GXV1 = 1;
            while ( AV20GXV1 <= AV10Errors.Count )
            {
               AV9Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV10Errors.Item(AV20GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20241217042937", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gameventsubscriptionentry.js", "?20241217042937", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","""{"handler":"E12272","iparms":[{"av":"AV14Id","fld":"vID","hsh":true},{"av":"Gx_mode","fld":"vMODE","pic":"@!","hsh":true},{"av":"AV8Description","fld":"vDESCRIPTION"},{"av":"cmbavEvent"},{"av":"AV11Event","fld":"vEVENT"},{"av":"AV13FileName","fld":"vFILENAME"},{"av":"AV7ClassName","fld":"vCLASSNAME"},{"av":"AV15MethodName","fld":"vMETHODNAME"}]}""");
      ...
      public override void initialize( )
      {
         ...
         pr_gam = new DataStoreProvider(context, new DesignSystem.Programs.gameventsubscriptionentry__gam(),
            new Object[][] {
            }
         );
         pr_default = new DataStoreProvider(context, new DesignSystem.Programs.gameventsubscriptionentry__default(),
            new Object[][] {
            }
         );
         /* GeneXus formulas. */
