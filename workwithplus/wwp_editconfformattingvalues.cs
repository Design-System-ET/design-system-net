...
namespace DesignSystem.Programs.workwithplus {
   public class wwp_editconfformattingvalues : GXWebComponent
   {
      ...
      public void execute( string aP0_VarProgramName ,
                           GXBaseCollection<DesignSystem.Programs.workwithplus.SdtWWPConfFormattingVariable> aP1_ConfFormattingVariables )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(string)AV7VarProgramName,(GXBaseCollection<DesignSystem.Programs.workwithplus.SdtWWPConfFormattingVariable>)AV6ConfFormattingVariables});
                  componentstart();
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 10), "GRIDS.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              {
                                 AV6ConfFormattingVariables.CurrentItem = ((DesignSystem.Programs.workwithplus.SdtWWPConfFormattingVariable)AV6ConfFormattingVariables.Item(AV11GXV1));
      ...
      protected void gxgrGrids_refresh( int subGrids_Rows ,
                                        GXBaseCollection<DesignSystem.Programs.workwithplus.SdtWWPConfFormattingVariable> AV6ConfFormattingVariables ,
                                        string sPrefix )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      private void E15112( )
      {
         ...
         {
            AV6ConfFormattingVariables.CurrentItem = ((DesignSystem.Programs.workwithplus.SdtWWPConfFormattingVariable)AV6ConfFormattingVariables.Item(AV11GXV1));
            AV8DefaultValue = (long)(Math.Round(NumberUtil.Val( ((DesignSystem.Programs.workwithplus.SdtWWPConfFormattingVariable)(AV6ConfFormattingVariables.CurrentItem)).gxTpr_Defaultvalue, "."), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, edtavDefaultvalue_Internalname, StringUtil.LTrimStr( (decimal)(AV8DefaultValue), 10, 0));
            /* Load Method */
            if ( wbStart != -1 )
            {
      ...
      protected void E12112( )
      {
         ...
         {
            AV5ConfFormattingVariable = ((DesignSystem.Programs.workwithplus.SdtWWPConfFormattingVariable)AV6ConfFormattingVariables.Item(AV13GXV3));
            new DesignSystem.Programs.wwpbaseobjects.saveuserkeyvalue(context ).execute(  AV7VarProgramName+"."+AV5ConfFormattingVariable.gxTpr_Name,  "") ;
      ...
      protected void E13112( )
      {
         ...
         while ( nGXsfl_15_fel_idx < nRC_GXsfl_15 )
         {
            ...
            new DesignSystem.Programs.wwpbaseobjects.saveuserkeyvalue(context ).execute(  AV7VarProgramName+"."+((DesignSystem.Programs.workwithplus.SdtWWPConfFormattingVariable)(AV6ConfFormattingVariables.CurrentItem)).gxTpr_Name,  StringUtil.Trim( StringUtil.Str( (decimal)(AV8DefaultValue), 10, 0))) ;
            /* End For Each Line */
         }
         if ( nGXsfl_15_fel_idx == 0 )
         {
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri(sPrefix, false, "AV7VarProgramName", AV7VarProgramName);
         AV6ConfFormattingVariables = (GXBaseCollection<DesignSystem.Programs.workwithplus.SdtWWPConfFormattingVariable>)getParm(obj,1);
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         else
         {
            ...
            AssignAttri(sPrefix, false, "AV7VarProgramName", AV7VarProgramName);
            AV6ConfFormattingVariables = (GXBaseCollection<DesignSystem.Programs.workwithplus.SdtWWPConfFormattingVariable>)getParm(obj,3);
         }
         wcpOAV7VarProgramName = cgiGet( sPrefix+"wcpOAV7VarProgramName");
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            AV6ConfFormattingVariables = new GXBaseCollection<DesignSystem.Programs.workwithplus.SdtWWPConfFormattingVariable>();
         }
         else
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024121623355915", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/wwp_editconfformattingvalues.js", "?2024121623355915", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/GridEmpowerer/GridEmpowererRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDS.LOAD","""{"handler":"E15112","iparms":[{"av":"AV6ConfFormattingVariables","fld":"vCONFFORMATTINGVARIABLES","grid":15},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"GRIDS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_15","ctrl":"GRIDS","prop":"GridRC","grid":15}]""");
         setEventMetadata("GRIDS.LOAD",""","oparms":[{"av":"AV8DefaultValue","fld":"vDEFAULTVALUE","pic":"ZZZZZZZZZ9"}]}""");
         setEventMetadata("'DOUSERACTION1'","""{"handler":"E11111","iparms":[]}""");
         setEventMetadata("'DOUSERACTIONRESET'","""{"handler":"E12112","iparms":[{"av":"AV6ConfFormattingVariables","fld":"vCONFFORMATTINGVARIABLES","grid":15},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"GRIDS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_15","ctrl":"GRIDS","prop":"GridRC","grid":15},{"av":"AV7VarProgramName","fld":"vVARPROGRAMNAME"}]}""");
         setEventMetadata("ENTER","""{"handler":"E13112","iparms":[{"av":"AV7VarProgramName","fld":"vVARPROGRAMNAME"},{"av":"AV6ConfFormattingVariables","fld":"vCONFFORMATTINGVARIABLES","grid":15},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"GRIDS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_15","ctrl":"GRIDS","grid":15,"prop":"GridRC","grid":15},{"av":"AV8DefaultValue","fld":"vDEFAULTVALUE","grid":15,"pic":"ZZZZZZZZZ9"}]}""");
      ...
      {
         AV6ConfFormattingVariables = new GXBaseCollection<DesignSystem.Programs.workwithplus.SdtWWPConfFormattingVariable>( context, "WWPConfFormattingVariable", "DesignSystem");
         ...
         AV5ConfFormattingVariable = new DesignSystem.Programs.workwithplus.SdtWWPConfFormattingVariable(context);
      ...
      private GXBaseCollection<DesignSystem.Programs.workwithplus.SdtWWPConfFormattingVariable> AV6ConfFormattingVariables ;
      private DesignSystem.Programs.workwithplus.SdtWWPConfFormattingVariable AV5ConfFormattingVariable ;
