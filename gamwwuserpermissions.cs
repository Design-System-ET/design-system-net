...
namespace DesignSystem.Programs {
   public class gamwwuserpermissions : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV47ManageFiltersExecutionStep, AV62Pgmname, AV10ApplicationId, AV16FilName, AV26PermissionAccessType, AV11BoolenFilter, AV31UserId, AV30SearchFilter, AV52IsAuthorized_Back, AV53IsAuthorized_Insert, AV24pApplicationId) ;
      ...
      {
         /* GeneXus formulas. */
         AV62Pgmname = "GAMWWUserPermissions";
      ...
      protected void E171C2( )
      {
         ...
         AV61GXV2 = 1;
         AV60GXV1 = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getapplications(AV9ApplicationFilter, out  AV15Errors);
         while ( AV61GXV2 <= AV60GXV1.Count )
         {
            AV8Application = ((GeneXus.Programs.genexussecurity.SdtGAMApplication)AV60GXV1.Item(AV61GXV2));
      ...
      protected void E181C2( )
      {
         ...
         new DesignSystem.Programs.wwpbaseobjects.wwp_getappliedfiltersdescription(context ).execute(  AV62Pgmname, out  GXt_char1) ;
      ...
      private void E191C2( )
      {
         ...
         if ( ! (0==AV10ApplicationId) )
         {
            ...
            AV63GXV3 = 1;
            while ( AV63GXV3 <= AV54Permissions.Count )
            {
               AV25Permission = ((GeneXus.Programs.genexussecurity.SdtGAMPermission)AV54Permissions.Item(AV63GXV3));
               AV12BtnDlt = "Delete";
               AssignAttri("", false, edtavBtndlt_Internalname, AV12BtnDlt);
      ...
      protected void E111C2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("GAMWWUserPermissionsFilters")) + "," + UrlEncode(StringUtil.RTrim(AV62Pgmname+"GridState"));
         ...
         else
         {
            ...
            new DesignSystem.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "GAMWWUserPermissionsFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char1) ;
            ...
            else
            {
               ...
               S152 ();
               if (returnInSub) return;
               new DesignSystem.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV62Pgmname+"GridState",  AV46ManageFiltersXml) ;
      ...
      protected void E161C2( )
      {
         ...
         while ( nGXsfl_57_fel_idx < nRC_GXsfl_57 )
         {
            ...
            if ( ( StringUtil.StrCmp(AV7AccessType, AV22old_AccessType) != 0 ) || ( AV19Inherited != AV23old_Inherited ) )
            {
               ...
               {
                  AV65GXV4 = 1;
                  while ( AV65GXV4 <= AV15Errors.Count )
                  {
                     AV14Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV15Errors.Item(AV65GXV4));
         ...
         {
            AV66GXV5 = 1;
            while ( AV66GXV5 <= AV15Errors.Count )
            {
               AV14Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV15Errors.Item(AV66GXV5));
               GX_msglist.addItem(StringUtil.Format( "%1 (GAM%2)", AV14Error.gxTpr_Message, StringUtil.LTrimStr( (decimal)(AV14Error.gxTpr_Code), 12, 0), "", "", "", "", "", "", ""));
      ...
      protected void S132( )
      {
         ...
         new DesignSystem.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "gamuserpermissionselect_Execute", out  GXt_boolean2) ;
      ...
      protected void S112( )
      {
         ...
         new DesignSystem.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "GAMWWUserPermissionsFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item3) ;
      ...
      protected void S122( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV44Session.Get(AV62Pgmname+"GridState"), "") == 0 )
         {
            AV42GridState.FromXml(new DesignSystem.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV62Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV42GridState.FromXml(AV44Session.Get(AV62Pgmname+"GridState"), null, "", "");
         }
         /* Execute user subroutine: 'LOADREGFILTERSSTATE' */
         S162 ();
         if (returnInSub) return;
      ...
      protected void S162( )
      {
         ...
         returnInSub = false;
         AV67GXV6 = 1;
         while ( AV67GXV6 <= AV42GridState.gxTpr_Filtervalues.Count )
         {
            AV43GridStateFilterValue = ((DesignSystem.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV42GridState.gxTpr_Filtervalues.Item(AV67GXV6));
      ...
      protected void S142( )
      {
         ...
         new DesignSystem.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV42GridState,  "FILNAME",  context.GetMessage( "WWP_GAM_Search", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV16FilName)),  0,  AV16FilName,  AV16FilName,  false,  "",  "") ;
         new DesignSystem.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV42GridState,  "PERMISSIONACCESSTYPE",  context.GetMessage( "WWP_GAM_AccessType", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV26PermissionAccessType)),  0,  AV26PermissionAccessType,  AV26PermissionAccessType,  false,  "",  "") ;
         new DesignSystem.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV42GridState,  "BOOLENFILTER",  context.GetMessage( "WWP_GAM_Inherited", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV11BoolenFilter)),  0,  AV11BoolenFilter,  AV11BoolenFilter,  false,  "",  "") ;
         ...
         new DesignSystem.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV62Pgmname+"GridState",  AV42GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void E201C2( )
      {
         ...
         {
            AV68GXV7 = 1;
            while ( AV68GXV7 <= AV15Errors.Count )
            {
               AV14Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV15Errors.Item(AV68GXV7));
               GX_msglist.addItem(StringUtil.Format( "%1 (GAM%2)", AV14Error.gxTpr_Message, StringUtil.LTrimStr( (decimal)(AV14Error.gxTpr_Code), 12, 0), "", "", "", "", "", "", ""));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202412162356427", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamwwuserpermissions.js", "?202412162356432", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E191C2","iparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV31UserId","fld":"vUSERID","hsh":true},{"av":"cmbavApplicationid"},{"av":"AV10ApplicationId","fld":"vAPPLICATIONID","pic":"ZZZZZZZZZZZ9"},{"av":"AV16FilName","fld":"vFILNAME"},{"av":"AV30SearchFilter","fld":"vSEARCHFILTER","hsh":true},{"av":"cmbavPermissionaccesstype"},{"av":"AV26PermissionAccessType","fld":"vPERMISSIONACCESSTYPE"},{"av":"cmbavBoolenfilter"},{"av":"AV11BoolenFilter","fld":"vBOOLENFILTER"}]""");
         ...
         setEventMetadata("'DOBACK'","""{"handler":"E141C2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV47ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV62Pgmname","fld":"vPGMNAME","hsh":true},{"av":"cmbavApplicationid"},{"av":"AV10ApplicationId","fld":"vAPPLICATIONID","pic":"ZZZZZZZZZZZ9"},{"av":"AV16FilName","fld":"vFILNAME"},{"av":"cmbavPermissionaccesstype"},{"av":"AV26PermissionAccessType","fld":"vPERMISSIONACCESSTYPE"},{"av":"cmbavBoolenfilter"},{"av":"AV11BoolenFilter","fld":"vBOOLENFILTER"},{"av":"AV31UserId","fld":"vUSERID","hsh":true},{"av":"AV30SearchFilter","fld":"vSEARCHFILTER","hsh":true},{"av":"AV52IsAuthorized_Back","fld":"vISAUTHORIZED_BACK","hsh":true},{"av":"AV53IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"AV24pApplicationId","fld":"vPAPPLICATIONID","pic":"ZZZZZZZZZZZ9","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         GXKey = "";
         GXEncryptionTmp = "";
         AV45ManageFiltersData = new GXBaseCollection<DesignSystem.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item>( context, "Item", "");
         ...
         AV18Id = "";
         GXDecQS = "";
         AV60GXV1 = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMApplication>( context, "GeneXus.Programs.genexussecurity.SdtGAMApplication", "DesignSystem.Programs");
         ...
         AV54Permissions = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMPermission>( context, "GeneXus.Programs.genexussecurity.SdtGAMPermission", "DesignSystem.Programs");
         ...
         pr_gam = new DataStoreProvider(context, new DesignSystem.Programs.gamwwuserpermissions__gam(),
            new Object[][] {
            }
         );
         pr_default = new DataStoreProvider(context, new DesignSystem.Programs.gamwwuserpermissions__default(),
            new Object[][] {
            }
         );
         AV62Pgmname = "GAMWWUserPermissions";
      ...
      private GXBaseCollection<DesignSystem.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item> AV45ManageFiltersData ;
      private DesignSystem.Programs.wwpbaseobjects.SdtWWPGridState AV42GridState ;
      private GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMApplication> AV60GXV1 ;
