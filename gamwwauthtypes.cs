...
namespace DesignSystem.Programs {
   public class gamwwauthtypes : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV52ManageFiltersExecutionStep, AV46ColumnsSelector, AV73Pgmname, AV12FilName, AV65IsAuthorized_Display, AV66IsAuthorized_Update, AV67IsAuthorized_Delete, AV16IsAuthorized_BtnTestWS, AV18IsAuthorized_Name, AV68IsAuthorized_Insert) ;
      ...
      protected void E161O2( )
      {
         ...
         new DesignSystem.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "gamauthenticationtypeentry_Execute", out  GXt_boolean1) ;
      ...
      protected void E171O2( )
      {
         ...
         cmbavTypeid.Visible = (((DesignSystem.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV46ColumnsSelector.gxTpr_Columns.Item(2)).gxTpr_Isvisible ? 1 : 0);
         ...
         new DesignSystem.Programs.wwpbaseobjects.wwp_getappliedfiltersdescription(context ).execute(  AV73Pgmname, out  GXt_char3) ;
      ...
      private void E181O2( )
      {
         ...
         AV74GXV1 = 1;
         while ( AV74GXV1 <= AV23GAMAuthTypes.Count )
         {
            AV6AuthenticationType = ((GeneXus.Programs.genexussecurity.SdtGAMAuthenticationType)AV23GAMAuthTypes.Item(AV74GXV1));
      ...
      protected void E141O2( )
      {
         ...
         new DesignSystem.Programs.wwpbaseobjects.savecolumnsselectorstate(context ).execute(  "GAMWWAuthTypesColumnsSelector",  (String.IsNullOrEmpty(StringUtil.RTrim( AV34ColumnsSelectorXML)) ? "" : AV46ColumnsSelector.ToXml(false, true, "", ""))) ;
      ...
      protected void E111O2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("GAMWWAuthTypesFilters")) + "," + UrlEncode(StringUtil.RTrim(AV73Pgmname+"GridState"));
         ...
         else
         {
            ...
            new DesignSystem.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "GAMWWAuthTypesFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
            ...
            else
            {
               ...
               S162 ();
               if (returnInSub) return;
               new DesignSystem.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV73Pgmname+"GridState",  AV53ManageFiltersXml) ;
      ...
      protected void S152( )
      {
         ...
         new DesignSystem.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV46ColumnsSelector,  "&Name",  "",  "WWP_GAM_Name",  true,  "") ;
         new DesignSystem.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV46ColumnsSelector,  "&TypeId",  "",  "WWP_GAM_Type",  true,  "") ;
         GXt_char3 = AV41UserCustomValue;
         new DesignSystem.Programs.wwpbaseobjects.loadcolumnsselectorstate(context ).execute(  "GAMWWAuthTypesColumnsSelector", out  GXt_char3) ;
         ...
         if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV41UserCustomValue)) ) )
         {
            ...
            new DesignSystem.Programs.wwpbaseobjects.wwp_columnselector_updatecolumns(context ).execute( ref  AV61ColumnsSelectorAux, ref  AV46ColumnsSelector) ;
         }
      }
      ...
      protected void S132( )
      {
         ...
         new DesignSystem.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "gamtestexternallogin_Execute", out  GXt_boolean1) ;
      ...
      protected void S112( )
      {
         ...
         new DesignSystem.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "GAMWWAuthTypesFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV51Session.Get(AV73Pgmname+"GridState"), "") == 0 )
         {
            AV32GridState.FromXml(new DesignSystem.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV73Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV32GridState.FromXml(AV51Session.Get(AV73Pgmname+"GridState"), null, "", "");
         }
         /* Execute user subroutine: 'LOADREGFILTERSSTATE' */
         S172 ();
         if (returnInSub) return;
      ...
      protected void S172( )
      {
         ...
         returnInSub = false;
         AV75GXV2 = 1;
         while ( AV75GXV2 <= AV32GridState.gxTpr_Filtervalues.Count )
         {
            AV33GridStateFilterValue = ((DesignSystem.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV32GridState.gxTpr_Filtervalues.Item(AV75GXV2));
      ...
      protected void S142( )
      {
         ...
         new DesignSystem.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV32GridState,  "FILNAME",  context.GetMessage( "WWP_GAM_Name", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV12FilName)),  0,  AV12FilName,  AV12FilName,  false,  "",  "") ;
         ...
         new DesignSystem.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV73Pgmname+"GridState",  AV32GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024121623593719", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamwwauthtypes.js", "?2024121623593724", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"edtavBtntestws_Title","ctrl":"vBTNTESTWS","prop":"Title"},{"av":"AV52ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV46ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV73Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV12FilName","fld":"vFILNAME"},{"av":"AV65IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV66IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV67IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV16IsAuthorized_BtnTestWS","fld":"vISAUTHORIZED_BTNTESTWS","hsh":true},{"av":"AV18IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true},{"av":"AV68IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true}]""");
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E181O2","iparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV12FilName","fld":"vFILNAME"},{"av":"AV65IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV66IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV67IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV16IsAuthorized_BtnTestWS","fld":"vISAUTHORIZED_BTNTESTWS","hsh":true},{"av":"AV18IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E151O2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV52ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV46ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV73Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV12FilName","fld":"vFILNAME"},{"av":"edtavBtntestws_Title","ctrl":"vBTNTESTWS","prop":"Title"},{"av":"AV65IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV66IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV67IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV16IsAuthorized_BtnTestWS","fld":"vISAUTHORIZED_BTNTESTWS","hsh":true},{"av":"AV18IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true},{"av":"AV68IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         AV23GAMAuthTypes = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMAuthenticationType>( context, "GeneXus.Programs.genexussecurity.SdtGAMAuthenticationType", "DesignSystem.Programs");
