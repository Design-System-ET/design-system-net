   ...
   public class gamauthenticationtypeentry : GXDataArea
   {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        if ( nCmpId == 25 )
                        {
                           ...
                           {
                              WebComp_Wcentrypanel = getWebComponent(GetType(), "DesignSystem.Programs", OldWcentrypanel, new Object[] {context} );
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(AV6TypeId, "Oauth20") == 0 )
         {
            ...
            {
               WebComp_Wcentrypanel = getWebComponent(GetType(), "DesignSystem.Programs", "gamwcauthenticationtypeentryoauth20", new Object[] {context} );
               WebComp_Wcentrypanel.ComponentInit();
         ...
         else if ( StringUtil.StrCmp(AV6TypeId, "Saml20") == 0 )
         {
            ...
            {
               WebComp_Wcentrypanel = getWebComponent(GetType(), "DesignSystem.Programs", "gamwcauthenticationtypeentrysaml20", new Object[] {context} );
               WebComp_Wcentrypanel.ComponentInit();
         ...
         else
         {
            if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV6TypeId)) )
            {
               ...
               {
                  WebComp_Wcentrypanel = getWebComponent(GetType(), "DesignSystem.Programs", "gamwcauthenticationtypeentrygeneral", new Object[] {context} );
                  WebComp_Wcentrypanel.ComponentInit();
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024121623551439", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamauthenticationtypeentry.js", "?2024121623551439", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VTYPEID.CLICK","""{"handler":"E121F2","iparms":[{"av":"cmbavTypeid"},{"av":"AV6TypeId","fld":"vTYPEID"},{"av":"Gx_mode","fld":"vMODE","pic":"@!","hsh":true},{"av":"AV5Name","fld":"vNAME","hsh":true}]""");
