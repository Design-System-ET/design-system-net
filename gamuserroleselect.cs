...
namespace DesignSystem.Programs {
   public class gamuserroleselect : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV40ManageFiltersExecutionStep, AV52Pgmname, AV12FilName, AV28GAMDescriptionLong, AV22UserId, AV11FilExternalId) ;
      ...
      protected void E16222( )
      {
         ...
         new DesignSystem.Programs.wwpbaseobjects.wwp_getappliedfiltersdescription(context ).execute(  AV52Pgmname, out  GXt_char1) ;
      ...
      private void E17222( )
      {
         ...
         AV53GXV1 = 1;
         while ( AV53GXV1 <= AV27GAMRoles.Count )
         {
            AV14GAMRole = ((GeneXus.Programs.genexussecurity.SdtGAMRole)AV27GAMRoles.Item(AV53GXV1));
            AV10Exists = false;
            AV55GXV3 = 1;
            AV54GXV2 = AV15GAMUser.getroles(out  AV9Errors);
            while ( AV55GXV3 <= AV54GXV2.Count )
            {
               AV19Role = ((GeneXus.Programs.genexussecurity.SdtGAMRole)AV54GXV2.Item(AV55GXV3));
      ...
      protected void E11222( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("GAMUserRoleSelectFilters")) + "," + UrlEncode(StringUtil.RTrim(AV52Pgmname+"GridState"));
         ...
         else
         {
            ...
            new DesignSystem.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "GAMUserRoleSelectFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char1) ;
            ...
            else
            {
               ...
               S142 ();
               if (returnInSub) return;
               new DesignSystem.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV52Pgmname+"GridState",  AV41ManageFiltersXml) ;
      ...
      protected void E14222( )
      {
         ...
         while ( nGXsfl_38_fel_idx < nRC_GXsfl_38 )
         {
            ...
            if ( AV21Select )
            {
               ...
               {
                  AV57GXV4 = 1;
                  while ( AV57GXV4 <= AV9Errors.Count )
                  {
                     AV8Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV9Errors.Item(AV57GXV4));
         ...
         {
            AV58GXV5 = 1;
            while ( AV58GXV5 <= AV9Errors.Count )
            {
               AV8Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV9Errors.Item(AV58GXV5));
               GX_msglist.addItem(StringUtil.Format( "%1 (GAM%2)", AV8Error.gxTpr_Message, StringUtil.LTrimStr( (decimal)(AV8Error.gxTpr_Code), 12, 0), "", "", "", "", "", "", ""));
      ...
      protected void S112( )
      {
         ...
         new DesignSystem.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "GAMUserRoleSelectFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item2) ;
      ...
      protected void S122( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV39Session.Get(AV52Pgmname+"GridState"), "") == 0 )
         {
            AV37GridState.FromXml(new DesignSystem.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV52Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV37GridState.FromXml(AV39Session.Get(AV52Pgmname+"GridState"), null, "", "");
         }
         /* Execute user subroutine: 'LOADREGFILTERSSTATE' */
         S152 ();
         if (returnInSub) return;
      ...
      protected void S152( )
      {
         ...
         returnInSub = false;
         AV59GXV6 = 1;
         while ( AV59GXV6 <= AV37GridState.gxTpr_Filtervalues.Count )
         {
            AV38GridStateFilterValue = ((DesignSystem.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV37GridState.gxTpr_Filtervalues.Item(AV59GXV6));
      ...
      protected void S132( )
      {
         ...
         new DesignSystem.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV37GridState,  "FILNAME",  context.GetMessage( "WWP_GAM_Name", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV12FilName)),  0,  AV12FilName,  AV12FilName,  false,  "",  "") ;
         new DesignSystem.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV37GridState,  "GAMDESCRIPTIONLONG",  context.GetMessage( "WWP_GAM_ExternalId", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV28GAMDescriptionLong)),  0,  AV28GAMDescriptionLong,  AV28GAMDescriptionLong,  false,  "",  "") ;
         ...
         new DesignSystem.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV52Pgmname+"GridState",  AV37GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void S162( )
      {
         ...
         {
            AV60GXV7 = 1;
            while ( AV60GXV7 <= AV9Errors.Count )
            {
               AV8Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV9Errors.Item(AV60GXV7));
               GX_msglist.addItem(StringUtil.Format( "%1 (GAM%2)", AV8Error.gxTpr_Message, StringUtil.LTrimStr( (decimal)(AV8Error.gxTpr_Code), 12, 0), "", "", "", "", "", "", ""));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024121702953", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamuserroleselect.js", "?2024121702959", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"AV40ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV52Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV12FilName","fld":"vFILNAME"},{"av":"AV28GAMDescriptionLong","fld":"vGAMDESCRIPTIONLONG"},{"av":"AV22UserId","fld":"vUSERID","hsh":true},{"av":"AV11FilExternalId","fld":"vFILEXTERNALID","hsh":true}]""");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E12222","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV40ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV52Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV12FilName","fld":"vFILNAME"},{"av":"AV28GAMDescriptionLong","fld":"vGAMDESCRIPTIONLONG"},{"av":"AV22UserId","fld":"vUSERID","hsh":true},{"av":"AV11FilExternalId","fld":"vFILEXTERNALID","hsh":true},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","""{"handler":"E13222","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV40ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV52Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV12FilName","fld":"vFILNAME"},{"av":"AV28GAMDescriptionLong","fld":"vGAMDESCRIPTIONLONG"},{"av":"AV22UserId","fld":"vUSERID","hsh":true},{"av":"AV11FilExternalId","fld":"vFILEXTERNALID","hsh":true},{"av":"Gridpaginationbar_Rowsperpageselectedvalue","ctrl":"GRIDPAGINATIONBAR","prop":"RowsPerPageSelectedValue"}]""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",""","oparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E17222","iparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV22UserId","fld":"vUSERID","hsh":true},{"av":"AV12FilName","fld":"vFILNAME"},{"av":"AV11FilExternalId","fld":"vFILEXTERNALID","hsh":true}]""");
         ...
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","""{"handler":"E11222","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV40ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV52Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV12FilName","fld":"vFILNAME"},{"av":"AV28GAMDescriptionLong","fld":"vGAMDESCRIPTIONLONG"},{"av":"AV22UserId","fld":"vUSERID","hsh":true},{"av":"AV11FilExternalId","fld":"vFILEXTERNALID","hsh":true},{"av":"Ddo_managefilters_Activeeventkey","ctrl":"DDO_MANAGEFILTERS","prop":"ActiveEventKey"},{"av":"AV37GridState","fld":"vGRIDSTATE"}]""");
         ...
         setEventMetadata("'DOADDSELECTED'","""{"handler":"E14222","iparms":[{"av":"AV22UserId","fld":"vUSERID","hsh":true},{"av":"AV21Select","fld":"vSELECT","grid":38},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_38","ctrl":"GRID","grid":38,"prop":"GridRC","grid":38},{"av":"AV16Id","fld":"vID","grid":38,"pic":"ZZZZZZZZZZZ9","hsh":true},{"av":"AV17isOK","fld":"vISOK"}]""");
      ...
      public override void initialize( )
      {
         ...
         GXKey = "";
         GXEncryptionTmp = "";
         AV44ManageFiltersData = new GXBaseCollection<DesignSystem.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item>( context, "Item", "");
         ...
         AV6BtnAddRole = "";
         AV27GAMRoles = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMRole>( context, "GeneXus.Programs.genexussecurity.SdtGAMRole", "DesignSystem.Programs");
         ...
         AV54GXV2 = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMRole>( context, "GeneXus.Programs.genexussecurity.SdtGAMRole", "DesignSystem.Programs");
         ...
         GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item2 = new GXBaseCollection<DesignSystem.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item>( context, "Item", "");
         ...
         pr_gam = new DataStoreProvider(context, new DesignSystem.Programs.gamuserroleselect__gam(),
            new Object[][] {
            }
         );
         pr_default = new DataStoreProvider(context, new DesignSystem.Programs.gamuserroleselect__default(),
            new Object[][] {
            }
         );
         AV52Pgmname = "GAMUserRoleSelect";
      ...
      private GXBaseCollection<DesignSystem.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item> AV44ManageFiltersData ;
      ...
      private GXBaseCollection<DesignSystem.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item> GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item2 ;
