...
namespace DesignSystem.Programs.general.ui {
   public class masterunanimosidebar : GXMasterPage
   {
      ...
      protected void RenderHtmlCloseForm012( )
      {
         ...
         context.AddJavascriptSource("general/ui/masterunanimosidebar.js", "?2024121623412221", false, true);
      ...
      protected void E11012( )
      {
         ...
         new DesignSystem.Programs.general.ui.sidebaritemsdp(context ).execute( out  GXt_objcol_SdtSidebarItems_SidebarItem1) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?2024121623412243", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("general/ui/masterunanimosidebar.js", "?2024121623412243", false, true);
         context.AddJavascriptSource("Unanimo_chameleon/chameleon-loader.js", "", false, true);
         context.AddJavascriptSource("UserControls/GeneXusUnanimo.SidebarRender.js", "", false, true);
