...
namespace DesignSystem.Programs {
   public class gamapppermissionentry : GXDataArea
   {
      ...
      protected void E121Q2( )
      {
         ...
         {
            AV20GXV2 = 1;
            while ( AV20GXV2 <= AV11Errors.Count )
            {
               AV10Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV11Errors.Item(AV20GXV2));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024121623574837", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamapppermissionentry.js", "?2024121623574838", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","""{"handler":"E121Q2","iparms":[{"av":"AV7ApplicationId","fld":"vAPPLICATIONID","pic":"ZZZZZZZZZZZ9","hsh":true},{"av":"AV12GUID","fld":"vGUID","hsh":true},{"av":"Gx_mode","fld":"vMODE","pic":"@!","hsh":true},{"av":"AV14Name","fld":"vNAME"},{"av":"AV9Dsc","fld":"vDSC"},{"av":"cmbavAccesstype"},{"av":"AV15AccessType","fld":"vACCESSTYPE"},{"av":"AV6isOK","fld":"vISOK"}]""");
      ...
      public override void initialize( )
      {
         ...
         pr_gam = new DataStoreProvider(context, new DesignSystem.Programs.gamapppermissionentry__gam(),
            new Object[][] {
            }
         );
         pr_default = new DataStoreProvider(context, new DesignSystem.Programs.gamapppermissionentry__default(),
            new Object[][] {
            }
         );
         /* GeneXus formulas. */
